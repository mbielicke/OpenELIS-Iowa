...
create view analysis_view (sample_id, domain, accession_number, received_date,
   ...
   select s.id, s.domain, s.accession_number, s.received_date, s.collection_date,
       s.collection_time, s.entered_date, o.name,
       case
...
create view sample_patient_view (sample_id, patient_id) as (
...
create view sample_view (sample_id, domain, accession_number, sample_revision, received_date,
   ...
   select s.id, s.domain, s.accession_number, s.revision, s.received_date,
       ...
       s.client_reference, s.released_date, o.id, o.name,
       case 
...
create view test_analyte_view (id, test_id, test_name, method_id, method_name,
                               ...
                               col_analyte_id, col_analyte_name) as
...
create view worksheet_qc_result_view (id, worksheet_analysis_id, sort_order, value_1,
   ...
   select wqr.id, wqr.worksheet_analysis_id, wqr.sort_order, wqr.value_1, wqr.value_2,
       ...
       wqr.value_27, wqr.value_28, wqr.value_29, wqr.value_30, q.name,
       q.type_id, q.source, ql.lot_number, ql.location_id, ql.prepared_date,
       ql.prepared_volume, ql.prepared_unit_id, ql.prepared_by_id, ql.usable_date, ql.expire_date,
       qa.analyte_id, qa.type_id, qa.value, w.format_id
