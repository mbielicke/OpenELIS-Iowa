...
/**
 * This is an implementation of the java.util.prefs.Preferences that is available on the client
...
public class Preferences implements RPC{
    ...
    /**
     * Id of user for this preference. 0 means System Preferences
     */
    ...
    /**
     * object used when pulling value from maps to determine null
     */
    private String val;
    ...
    /**
     * Returns the descendant node based on the path returned.  If node does not exist 
     * then it will be created with all intermediate nodes created in between as well
     * @param key
     * @return
     */
    ...
    /**
     * Returns the boolean value stored in the map for the passed key.  If the key
     * is not present or returns null the default parameter will be echoed back 
     * @param key
     * @param def
     * @return
    ...
    /**
     * Returns the int value stored in the map for the passed key.  If the key
     * is not present or returns null the default parameter will be echoed back 
     * @param key
     * @param def
     * @return
    ...
    /**
     * Returns the system_user for the user this preferences represent
     * @return
     */
    ...
    public void flush() {
    	...
    	try {
    		...
    		Window.alert("Preferences persistence failed : "+e.getMessage());
    	}
    }
