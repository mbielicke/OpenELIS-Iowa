...
<!-- main screen -->
    <screen name="{resource:getString($constants,'trailerForTest')}">
          ...
          <AbsolutePanel spacing="0" style="ButtonPanelContainer">
            <HorizontalPanel>
              ...
              <menu key="optionsMenu" selfShow="true" showBelow="true">
                  ...
                  <menuItem key="testTrailerHistory" description="" enabled="false" icon="historyIcon" display="{resource:getString($constants,'testTrailerHistory')}" />
              </menu>
            </HorizontalPanel>
          </AbsolutePanel>
<!--end button panel-->
