...
public class NotesTab extends Screen {
    ...
    public NotesTab(ScreenDefInt def, org.openelis.gwt.widget.Window window, String notesPanelKey,
    ...
    public void initialize() {
        ...
        final Button standardNote = (Button)def.getWidget(editButtonKey);
        addScreenHandler(standardNote, new ScreenEventHandler<Object>() {
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                standardNote.setEnabled(EnumSet.of(State.ADD,State.UPDATE).contains(event.getState()));
            }
        });
    }
