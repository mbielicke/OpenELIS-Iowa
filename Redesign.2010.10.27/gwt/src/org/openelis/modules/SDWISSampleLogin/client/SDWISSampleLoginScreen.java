...
public class SDWISSampleLoginScreen extends Screen implements HasActionHandlers {
    ...
    protected Button                  queryButton, addButton, updateButton, nextButton, prevButton,
    ...
    private void initialize() {
        ...
        historyUtility = new SampleHistoryUtility(window) {
            public void historyCurrentResult() {
                ActionEvent.fire(sdwisScreen, ResultTab.Action.RESULT_HISTORY, null);
            }
        };
        ...
        addScreenHandler(historySampleSdwis, new ScreenEventHandler<Object>() {
            public void onStateChange(StateChangeEvent<State> event) {
                historySampleSdwis.setEnabled(EnumSet.of(State.DISPLAY).contains(event.getState()));
            }
        });
        ...
        treeTab = new SampleItemAnalysisTreeTab(def, window, sdwisScreen);
