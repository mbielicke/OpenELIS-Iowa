...
public class TestResultTypeCacheHandler implements
                                       MessageHandler<TestResultTypeCacheMessage> {

    public static int version = 0;
       
    public void handle(TestResultTypeCacheMessage message) {
        CachingManager.remove("InitialData", "testResultTypeDropDown");   
        
    }
    
    public static TableDataModel<TableDataRow<Integer>> getTestResultTypes() {
        TableDataModel<TableDataRow<Integer>> model = (TableDataModel<TableDataRow<Integer>>)CachingManager.getElement("InitialData", "testResultTypeDropDown");
        TableDataRow<Integer> row = null;
        if(model == null) {
            CategoryRemote remote = (CategoryRemote)EJBFactory.lookup("openelis/CategoryBean/remote");        
            Integer id = remote.getCategoryId("test_result_type");
            ...
            CachingManager.putElement("InitialData", "testResultTypeDropDown", model);
            version++;
        }
        return model;
