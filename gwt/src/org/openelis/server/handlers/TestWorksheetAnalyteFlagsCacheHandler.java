...
public class TestWorksheetAnalyteFlagsCacheHandler implements
                                                  MessageHandler<TestWorksheetAnalyteFlagsCacheMessage> {

    public static int version = 0;
    
    public void handle(TestWorksheetAnalyteFlagsCacheMessage message) {
        CachingManager.remove("InitialData", "testWorksheetAnalyteFlagsDropDown");         
    }

    public static TableDataModel<TableDataRow<Integer>> getTestWorksheetAnalyteFlags() {
        TableDataModel<TableDataRow<Integer>> model = (TableDataModel<TableDataRow<Integer>>)CachingManager.getElement("InitialData", "testWorksheetAnalyteFlagsDropDown");
        TableDataRow<Integer> row = null;
        if(model == null) {
            CategoryRemote remote = (CategoryRemote)EJBFactory.lookup("openelis/CategoryBean/remote");        
            Integer id = remote.getCategoryId("test_worksheet_analyte_flags");
            ...
            CachingManager.putElement("InitialData", "testWorksheetAnalyteFlagsDropDown", model);
            version++;
        }
        return model;
