...
public class UnitOfMeasureCacheHandler implements MessageHandler<UnitOfMeasureCacheMessage> {
    ...
    public static DataModel<Integer> getUnitsOfMeasure() {
        DataModel<Integer> model = (DataModel<Integer>)CachingManager.getElement("InitialData", "unitOfMeasureDropdown");
        if(model == null) {
