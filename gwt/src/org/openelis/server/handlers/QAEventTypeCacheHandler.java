...
public class QAEventTypeCacheHandler implements MessageHandler<QaEventTypeCacheMessage> {
  
    public static int version = 0;
    
    public void handle(QaEventTypeCacheMessage message) {
        CachingManager.remove("InitialData", "qaTypeDropDown");

    }       
    
    public static TableDataModel<TableDataRow<Integer>> getQAEventTypes() {
        TableDataModel<TableDataRow<Integer>> model = (TableDataModel<TableDataRow<Integer>>)CachingManager.getElement("InitialData", "qaTypeDropDown");
        if(model == null) {
