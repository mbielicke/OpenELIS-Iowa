...
public class TestAnalyteTypeCacheHandler implements
                                        MessageHandler<TestAnalyteTypeCacheMessage> {

    public static int version = 0;
    
    public void handle(TestAnalyteTypeCacheMessage message) {
        CachingManager.remove("InitialData", "testAnalyteTypeDropDown");        
    }
    
    public static TableDataModel<TableDataRow<Integer>> getTestAnalyteTypes() {
        TableDataModel<TableDataRow<Integer>> model = (TableDataModel<TableDataRow<Integer>>)CachingManager.getElement("InitialData", "testAnalyteTypeDropDown");
        TableDataRow<Integer> row = null;
        if(model == null) {
            CategoryRemote remote = (CategoryRemote)EJBFactory.lookup("openelis/CategoryBean/remote");        
            Integer id = remote.getCategoryId("test_analyte_type");
            ...
            CachingManager.putElement("InitialData", "testAnalyteTypeDropDown", model);
            version++;
        }
        return model;
