...
public class QuickEntryTabUI extends Screen {
    @UiTemplate("NeonatalTab.ui.xml")
    interface NeonatalTabUIBinder extends UiBinder<Widget, QuickEntryTabUI> {
    };
    ...
    public void onDataChange() {
        redraw = true;
        displaySampleNeonatal();
    }

    private void displaySampleNeonatal() {
        if ( !isVisible)
            return;
