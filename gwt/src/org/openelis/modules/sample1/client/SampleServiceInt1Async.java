...
public interface SampleServiceInt1Async {
    ...
    public void fetchByAnalysisQuery(Query query, SampleManager1.Load elements[],
                                     AsyncCallback<ArrayList<SampleManager1>> callback);
    ...
    public void fetchForUpdateByAnalyses(ArrayList<Integer> analysisIds,
                                         SampleManager1.Load elements[],
                                         AsyncCallback<ArrayList<SampleManager1>> callback);

    public void unlock(Integer sampleId, SampleManager1.Load elements[],
                       AsyncCallback<SampleManager1> callback);
