...
public class SampleItemsPopoutTreeLookup1 extends Screen {
    ...
    public SampleItemsPopoutTreeLookup1() throws Exception {
        super((ScreenDefInt)GWT.create(SampleItemsPopoutTreeDef1.class));
    ...
    private void initialize() {
        ...
        treeUtil = new SampleTreeUtility1(window, itemsTestsTree, this){
