...
public abstract class EOrderLookupUI extends Screen {
    ...
    private void initialize() {
        ...
        //
        addScreenHandler(paperOrderValidator, EOrderMeta.getPaperOrderValidator(), new ScreenHandler<String>() {
            public void onStateChange(StateChangeEvent event) {
                paperOrderValidator.setEnabled(true);
                paperOrderValidator.setQueryMode(true);
            }
