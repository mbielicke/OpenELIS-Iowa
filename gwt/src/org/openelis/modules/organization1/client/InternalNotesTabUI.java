...
public class InternalNotesTabUI extends Screen {
    ...
    interface OrganizationInternalNotesTabUIBinder extends UiBinder<Widget, InternalNotesTabUI> {
    };

    private static OrganizationInternalNotesTabUIBinder uiBinder = GWT.create(OrganizationInternalNotesTabUIBinder.class);
    ...
    private void initialize() {
        addScreenHandler(notePanel, "organizationIntNotesPanel", new ScreenHandler<String>() {
            public void onDataChange(DataChangeEvent event) {
                drawNotes();
            }
        });

        addScreenHandler(addNoteButton, "organizationIntNoteButton", new ScreenHandler<Object>() {
    ...
    protected void addNote(ClickEvent event) {
        ...
        text = null;
        /*
         * If the Organization has an internal editing note as requested by the
         * user then set the note's subject and text in the lookup. If there
