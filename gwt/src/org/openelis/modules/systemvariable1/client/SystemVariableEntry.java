        ...
        GWT.runAsync(new RunAsyncCallback() {
            public void onSuccess() {
                try {
                    ...
                    window.setName(Messages.get().systemVariable());
                    window.setSize("863px", "400px");
                    window.setContent(new SystemVariableScreenUI(window));
                    OpenELIS.getBrowser().addWindow(window, "systemVariable");
                } catch (Throwable e) {
