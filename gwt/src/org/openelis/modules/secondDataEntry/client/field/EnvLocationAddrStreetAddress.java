 ...
 */
public class EnvLocationAddrStreetAddress extends SingleField<TextBox<String>> {
    public EnvLocationAddrStreetAddress(VerificationScreen parentScreen,
    ...
    protected void init() {
        ...
        key = SampleMeta.LOCATION_ADDR_STREET_ADDRESS;
    ...
    /**
     * Copies environmental location address street address from the manager to
     * the editable widget
     */
    ...
    /**
     * Copies environmental location address street address from the editable
    ...
    public void copyToSample() {
        ...
        if (numEdit > 1 &&
            ...
            DataBaseUtil.isDifferent(addr, sm.getSampleEnvironmental()
                                             .getLocationAddress()
                                             .getStreetAddress())) {
            sm.getSampleEnvironmental().getLocationAddress().setStreetAddress(addr);
     ...
     * sample's environmental location address street address; increments the
     ...
     * environmental location address street address to the user
     */
    ...
    /**
     * Verifies whether the value entered by the user is the same as the
     * sample's environmental location address street address
     */
    public void verify() {
