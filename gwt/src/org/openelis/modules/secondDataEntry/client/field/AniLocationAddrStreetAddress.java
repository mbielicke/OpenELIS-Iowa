 ...
 */
public class AniLocationAddrStreetAddress extends SingleField<TextBox<String>> {
    public AniLocationAddrStreetAddress(VerificationScreen parentScreen,
    ...
    protected void init() {
        ...
        key = SampleMeta.ANI_LOCATION_ADDR_STREET_ADDRESS;
    ...
    /**
     * Copies animal location address street address from the manager to
     * the editable widget
     */
    ...
    /**
     * Copies animal location address street address from the editable
    ...
    public void copyToSample() {
        ...
        if (numEdit > 1 &&
            ...
            DataBaseUtil.isDifferent(addr, sm.getSampleAnimal()
                                             .getLocationAddress()
                                             .getStreetAddress())) {
            sm.getSampleAnimal().getLocationAddress().setStreetAddress(addr);
     ...
     * sample's animal location address street address; increments the
     ...
     * animal location address street address to the user
     */
    ...
    /**
     * Verifies whether the value entered by the user is the same as the
     * sample's animal location address street address
     */
    public void verify() {
