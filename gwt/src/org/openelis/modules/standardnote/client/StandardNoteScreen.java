...
public class StandardNoteScreen extends Screen {
    ...
    public StandardNoteScreen(WindowInt window) throws Exception {
        ...
        if (userPermission == null)
            throw new PermissionException(Messages.get().screenPermException("Standard Note Screen"));
    ...
    protected void history() {
        ...
        HistoryScreen.showHistory(Messages.get().standardNoteHistory(),
