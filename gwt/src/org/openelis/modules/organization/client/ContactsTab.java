...
public class ContactsTab extends Screen {
    ...
    private AppButton           removeContactButton, addContactButton;
    ...
    private void initialize() {
        ...
        removeContactButton = (AppButton)def.getWidget("removeContactButton");
        addScreenHandler(removeContactButton, new ScreenEventHandler<Object>() {
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                removeContactButton.enable(EnumSet.of(State.ADD, State.UPDATE).contains(event.getState()));
            }
        });

        addContactButton = (AppButton)def.getWidget("addContactButton");
        addScreenHandler(addContactButton, new ScreenEventHandler<Object>() {
            public void onClick(ClickEvent event) {
                int n;
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                addContactButton.enable(EnumSet.of(State.ADD, State.UPDATE).contains(event.getState()));
            }
        });
    }
