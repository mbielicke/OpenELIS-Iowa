...
public class VendorOrderItemTabUI extends Screen {
    @UiTemplate("VendorOrderItemTab.ui.xml")
    interface VendorOrderItemTabUiBinder extends UiBinder<Widget, VendorOrderItemTabUI> {
    };
        ...
        if (count1 == count2) {
            ...
            for (int i = 0; i < count1; i++ ) {
                ...
                if (DataBaseUtil.isDifferent(item1.getQuantity(), item2.getQuantity()) ||
                    ...
                    DataBaseUtil.isDifferent(item1.getUnitCost(), item2.getUnitCost()) ||
                    DataBaseUtil.isDifferent(item1.getCatalogNumber(), item2.getCatalogNumber())) {
                    dataChanged = true;
                    break;
                }
            }
