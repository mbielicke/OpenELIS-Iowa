...
public class PrivateWellWaterSampleLoginScreen extends OpenELISScreenForm<RPC<Form,Data>,Form> implements ClickListener, TabListener, TreeManager{

    private TreeWidget itemsTestsTree;
    private KeyListManager keyList = new KeyListManager();
    
    public PrivateWellWaterSampleLoginScreen() {
        super("org.openelis.modules.privateWellWaterSampleLogin.server.PrivateWellWaterSampleLoginService", false, new RPC<Form,Data>());
    }
