...
public class VerificationEntry implements EntryPoint {
    
    public void onModuleLoad() {
        OpenELISEntry.mainBus.addHandler(OpenELIS.VERIFICATION, new ShowScreenHandler() {
            public void showScreen() {
                GWT.runAsync(new RunAsyncCallback() {
                    public void onSuccess() {
                        try {
                            org.openelis.ui.widget.Window window = new org.openelis.ui.widget.Window(false);
                            window.setName(OpenELIS.getMessages().verification());
