...
public class AuxiliaryEntry implements EntryPoint, ShowScreenHandler {
        ...
        GWT.runAsync(new RunAsyncCallback() {
            public void onSuccess() {
                try {
                    ...
                    window.setName(Messages.get().auxiliaryPrompt());
                    window.setSize("900px", "650px");
                    window.setContent(new AuxiliaryScreenUI(window));
                    OpenELIS.getBrowser().addWindow(window, "auxiliaryPrompt");
                } catch (Throwable e) {
