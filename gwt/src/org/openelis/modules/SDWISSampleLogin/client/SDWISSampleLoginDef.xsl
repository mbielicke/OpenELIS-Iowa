        ...
        <VerticalPanel padding="0" spacing="0" style="WhiteContentPanel">
          <TablePanel style="Form">
            <row>
              ...
              <textbox key="{meta:getCollectionTime()}" begin="3" end="5" width="60" mask="{resource:getString($constants,'timeMask')}" pattern="{resource:getString($constants,'timePattern')}" tab="{meta:getReceivedDate()},{meta:getCollectionDate()}" field="Date" />
            </row>
            <row>
              <text style="Prompt">
