...
<!-- Sample deck -->
          <tab text="Sample" visible="false" tab="{meta:getAccessionNumber()},{meta:getClientReference()}">
...
<!-- Analysis Notes Deck -->
          <tab text="Analysis Notes" visible="false" tab="anExNoteButton,anIntNoteButton">
