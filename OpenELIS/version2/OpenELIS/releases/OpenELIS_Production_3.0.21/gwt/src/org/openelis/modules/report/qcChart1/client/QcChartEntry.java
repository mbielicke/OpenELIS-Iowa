...
public class QcChartEntry implements EntryPoint, ShowScreenHandler {
    ...
    public void onModuleLoad() {
        ScreenBus.get().addHandler(ScreenBus.QC_CHART_REPORT_1, this);
    }
        ...
        GWT.runAsync(new RunAsyncCallback() {
            public void onSuccess() {
                try {
                    ...
                    window.setName(Messages.get().qcChart_qcChart());
                    window.setSize("960px", "485px");
                    window.setContent(new QcChartScreenUI(window));
                    OpenELIS.getBrowser().addWindow(window, "qcChart1");
                } catch (Throwable e) {
