 ...
 * address city
 */
public class EnvLocationAddrCity extends SingleField<TextBox<String>> {
    public EnvLocationAddrCity(VerificationScreen parentScreen, TableRowElement tableRowElement,
    ...
    /**
     * Copies environmental location address city from the manager to the
     * editable widget
     */
    public void copyFromSample() {
        ...
        if (numEdit > 1 &&
            DataBaseUtil.isDifferent(editableWidget.getValue(), sm.getSampleEnvironmental()
                                                                  .getLocationAddress()
                                                                  .getCity())) {
            editableWidget.setValue(sm.getSampleEnvironmental().getLocationAddress().getCity());
    ...
    /**
     * Copies environmental location address city from the editable widget to
     * the manager
     */
    public void copyToSample() {
        ...
        if (numEdit > 1 &&
            ...
            DataBaseUtil.isDifferent(city, sm.getSampleEnvironmental()
                                             .getLocationAddress()
                                             .getCity())) {
            sm.getSampleEnvironmental().getLocationAddress().setCity(city);
     ...
     * sample's environmental location address city; increments the number of
     ...
     * location address city to the user
     */
    ...
    /**
     * Verifies whether the value entered by the user is the same as the
     * sample's environmental location address city
     */
    public void verify() {
