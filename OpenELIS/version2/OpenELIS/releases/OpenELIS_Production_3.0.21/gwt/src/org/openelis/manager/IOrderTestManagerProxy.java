...
public class IOrderTestManagerProxy {
    ...
    public IOrderTestManagerProxy() {
    }
    
    public IOrderTestManager fetchByIorderId(Integer iorderId) throws Exception {
        return OrderService.get().fetchTestByIorderId(iorderId);
    }
