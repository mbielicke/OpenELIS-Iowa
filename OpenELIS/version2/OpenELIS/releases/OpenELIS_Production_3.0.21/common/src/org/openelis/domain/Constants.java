...
public class Constants implements Serializable {
    ...
    public static class Table implements Serializable {
        ...
        public final Integer      PATIENT          = 2, PATIENT_RELATION = 3, PROVIDER = 4,
                        ...
                        QC_LOT = 118, SAMPLE_NEONATAL = 119, EORDER = 129, EORDER_BODY = 130,
                        EORDER_LINK = 131, SAMPLE_PT = 132, ATTACHMENT_ISSUE = 134;
    }
    ...
    public static class Domain implements Serializable {
        ...
        public final String       QUICKENTRY, ENVIRONMENTAL, SDWIS, PRIVATEWELL,
                                  NEONATAL, CLINICAL, ANIMAL, PT;
    ...
    public static class Dictionary implements Serializable {
        ...
        public Integer            ANALYSIS_CANCELLED, ANALYSIS_COMPLETED, ANALYSIS_ERROR_COMPLETED,
                        ...
                        POS_LAST_OF_SUBSET_AND_RUN, POS_REAGENT_MEDIA, PROFILE_AIR_STRING,
                        PROFILE_ORDER_IN, PT_SAMPLE, QAEVENT_INTERNAL, QAEVENT_OVERRIDE,
