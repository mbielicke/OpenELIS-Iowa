...
public class SampleQcEntry implements EntryPoint, ShowScreenHandler {

    @Override
    public void onModuleLoad() {
        ScreenBus.get().addHandler(ScreenBus.SAMPLE_QC, this);
    }
        ...
        GWT.runAsync(new RunAsyncCallback() {
            public void onSuccess() {
                try {
                    ...
                    window.setName(Messages.get().sampleQc_sampleQc());
                    window.setSize("800px", "400px");
                    window.setContent(new SampleQcScreenUI(window));
                    OpenELIS.getBrowser().addWindow(window, "sampleQc");
                } catch (Throwable e) {
