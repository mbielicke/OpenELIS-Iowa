 ...
 * implement ReportScreen like Private Well Attachment
 */
public class PrivateWellAttachmentReportScreen extends ReportScreen<String> {

    public PrivateWellAttachmentReportScreen(WindowInt window) throws Exception {
    ...
    public void runReport(String accessions, AsyncCallback<ReportStatus> callback) {
        PrivateWellAttachmentReportService.get().runReport(accessions, callback);
    }
}