              ...
              <menuPanel key="optionsMenu" layout="vertical" style="topBarItemHolder">
                <menuItem>
                  ...
                  <menuPanel layout="vertical" position="below" style="topMenuContainer">
                    ...
                    <menuItem key="violationScan" description="" enable="false" icon="historyIcon" label="violationScan" visible="false"/>
                    <menuItem key="additionalScan" description="" enable="false" icon="historyIcon" label="additionalScan" visible="false"/>
                  </menuPanel>
                </menuItem>
              </menuPanel>
            </HorizontalPanel>
...
<!-- TAB PANEL -->
            <TabPanel key="tabPanel" width="725" height="270">
<!-- TAB 1 -->
