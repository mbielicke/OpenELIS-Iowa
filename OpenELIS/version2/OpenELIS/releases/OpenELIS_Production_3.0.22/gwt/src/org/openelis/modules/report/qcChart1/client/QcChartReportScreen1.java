 ...
 */
public class QcChartReportScreen1 extends ReportScreen<QcChartReportViewVO> {

    public QcChartReportScreen1(WindowInt window) throws Exception {
        this.window = window;
    }
    ...
    public void runReport(QcChartReportViewVO rpc, AsyncCallback<ReportStatus> callback) {
        QcChartReportService1.get().runReport(rpc,callback);
    }
}