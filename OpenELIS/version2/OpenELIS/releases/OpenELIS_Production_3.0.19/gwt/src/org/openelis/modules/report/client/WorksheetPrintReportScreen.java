 ...
 */
public class WorksheetPrintReportScreen extends ReportScreen<Query> {

    public WorksheetPrintReportScreen() throws Exception {
    ...
    protected ArrayList<Prompt> getPrompts() throws Exception {
        return WorksheetPrintReportService.get().getPrompts();
    }

    @Override
    public void runReport(Query query, AsyncCallback<ReportStatus> callback) {
        WorksheetPrintReportService.get().runReport(query, callback);
    }
}