      ...
      <DeckPanel height="100%" key="home" width="100%" style="ContentPanel">
        <deck>      
              <TablePanel height = "100" width="100%">
               <row> 
                 <html style="welcome"><xsl:value-of select='resource:getString($constants,"homeScreen.header1")' /></html>
               </row>                            
               <row> 
                 <html style="news"><xsl:value-of select='resource:getString($constants,"homeScreen.header2")' /></html>
               </row>              
              </TablePanel>
                   </deck>   
        </DeckPanel> 
