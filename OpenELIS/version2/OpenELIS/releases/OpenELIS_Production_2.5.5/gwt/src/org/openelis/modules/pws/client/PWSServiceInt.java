...
public interface PWSServiceInt extends XsrfProtectedService {
    ...
    PWSManager fetchWithViolations(Integer tinwsysIsNumber) throws Exception;
    ...
    PWSViolationManager fetchViolationByTinwsysIsNumber(Integer tinwsysIsNumber) throws Exception;

    PWSDO fetchPwsByNumber0(String pwsNumber0) throws Exception;

    void importFiles() throws Exception;

    void sdwisViolationScan() throws Exception;

    void sdwisAdditionalScan() throws Exception;
