...
public class DataExchangeExportBean {
    ...
    public ReportStatus export(ArrayList<Integer> accessions, ExchangeCriteriaManager cm) throws Exception {
        ...
        log.log(Level.INFO, "Fetching"+ ids.size()+" samples");
        sms = sampleManager.fetchByIds(ids,
                                       SampleManager1.Load.ORGANIZATION,
                                       SampleManager1.Load.PROJECT,
                                       SampleManager1.Load.QA,
    ...
    private ArrayList<Integer> message(ArrayList<SampleManager1> sms, ExchangeCriteriaManager cm) throws Exception {
        ...
        for (SampleManager1 sm : sms) {
            ...
            try {
                 ...
                 * an error
                 */
                log.log(Level.INFO, "Generating xml for accession number:  " + sm.getSample().getAccessionNumber());
                 ...
                 */
                log.log(Level.INFO, "Sending transformed xml to the destination:  " + cm.getExchangeCriteria().getDestinationUri());
                ...
                log.log(Level.INFO, "Generated xml for accession number: " + accession);
            } catch (Exception e) {
                accessions.add( -accession);
