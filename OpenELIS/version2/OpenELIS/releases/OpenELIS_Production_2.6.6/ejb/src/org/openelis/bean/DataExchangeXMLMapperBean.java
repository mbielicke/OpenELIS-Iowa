...
public class DataExchangeXMLMapperBean {
    ...
    public Document getXML(SampleManager1 sm, ExchangeCriteriaManager cm, Object... optional) throws Exception {
         ...
         */
        if (reportTo != null) {
            log.log(Level.INFO, "Fetching organization parameters for org id: "+reportTo.getOrganizationId());
            try {
        ...
        log.log(Level.INFO, "Fetching various referenced records e.g. tests, projects, qa events etc.");
        /*
