...
public class SecuritySystemUserDO implements RPC {
    ...
    public SecuritySystemUserDO(Integer id, String loginName, String lastName, String firstName,
                                String initials, String isEmployee, String isActive) {
        this.id = id;
    ...
    public SecuritySystemUserDO(Integer id, String loginName, String lastName, String firstName,
                                String initials, boolean isEmployee, boolean isActive) {
        this.id = id;
        this.loginName = loginName;
        this.lastName = lastName;
        this.firstName = firstName;
