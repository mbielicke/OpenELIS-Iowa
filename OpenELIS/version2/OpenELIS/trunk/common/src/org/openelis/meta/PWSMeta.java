...
public class PWSMeta implements Meta, MetaMap {
    ...
    private static final String    ID = "_pws.id", TINSWYS_IS_NUMBER = "_pws.tinwsysIsNumber",
                    NUMBER0 = "_pws.number0", ALTERNATE_ST_NUM = "_pws.alternateStNum",
                    NAME = "_pws.name", ACTIVITY_STATUS_CD = "_pws.activityStatusCd",
                    ...
                    ACTIVITY_RSN_TXT = "_pws.activityRsnTxt", START_DAY = "_pws.startDay",
                    START_MONTH = "_pws.startMonth", END_DAY = "_pws.endDay",
                    END_MONTH = "_pws.endMonth", EFF_BEGIN_DT = "_pws.effBeginDt",
                    EFF_END_DT = "_pws.effEndDt",

                    FAC_ID = "_pwsFacility.id",
                    FAC_TINSWYS_IS_NUMBER = "_pwsFacility.tinwsysIsNumber",
                    FAC_NAME = "_pwsFacility.name", FAC_TYPE_CODE = "_pwsFacility.typeCode",
                    ...
                    ADDR_ACTIVE_IND_CD = "_pwsAddress.activeIndCd", ADDR_NAME = "_pwsAddress.name",
                    ...
                    VIO_ID = "_pwsViolation.id", VIO_FACILITY_ID = "_pwsViolation.facilityId",
                    VIO_SERIES_NAME = "_pwsViolation.series",
                    VIO_VIOLATION_DATE = "_pwsViolation.violationDate",
                    VIO_SAMPLE_ID = "_pwsViolation.sampleId";
    ...
    static {
        names = new HashSet<String>(Arrays.asList(ID,
                                                  ...
                                                  EFF_END_DT,
                                                  ADDR_ID,
                                                  ADDR_TINSWYS_IS_NUMBER,
                                                  ADDR_TYPE_CODE,
                                                  ADDR_ACTIVE_IND_CD,
                                                  ADDR_NAME,
                                                  ADDR_ADDRESS_LINE_ONE_TEXT,
                                                  ADDR_ADDRESS_LINE_TWO_TEXT,
                                                  ADDR_ADDRESS_CITY_NAME,
                                                  ADDR_ADDRESS_STATE_CODE,
                                                  ADDR_ADDRESS_ZIP_CODE,
                                                  ADDR_STATE_FIPS_CODE,
                                                  ADDR_PHONE_NUMBER,
                                                  FAC_ID,
                                                  FAC_TINSWYS_IS_NUMBER,
                                                  FAC_NAME,
                                                  FAC_TYPE_CODE,
                                                  FAC_ST_ASGN_IDENT_CD,
                                                  FAC_ACTIVITY_STATUS_CD,
                                                  FAC_WATER_TYPE_CODE,
                                                  FAC_AVAILABILITY_CODE,
                                                  FAC_IDENTIFICATION_CD,
                                                  FAC_DESCRIPTION_TEXT,
                                                  FAC_SOURCE_TYPE_CODE,
                                                  MON_ID,
                                                  MON_TINSWYS_IS_NUMBER,
                                                  MON_ST_ASGN_IDENT_CD,
                                                  MON_NAME,
                                                  MON_TIAANLGP_TIAANLYT_NAME,
                                                  MON_NUMBER_SAMPLES,
                                                  MON_COMP_BEGIN_DATE,
                                                  MON_COMP_END_DATE,
                                                  MON_FREQUENCY_NAME,
    ...
    public static String getVioId() {
        return VIO_ID;
    }

    public static String getVioFacilityId() {
        return VIO_FACILITY_ID;
    }

    public static String getVioSeriesName() {
        return VIO_SERIES_NAME;
    }

    public static String getVioViolationDate() {
        return VIO_VIOLATION_DATE;
    }

    public static String getVioSampleId() {
        return VIO_SAMPLE_ID;
    }
    ...
    public String buildFrom(String where) {
        ...
        from = "PWS _pws ";
        /*
         * if (where.indexOf("pwsAddress.") > -1) from +=
         * ",IN (_pws.pwsAddress) _pwsAddress "; if
         * (where.indexOf("pwsFacility.") > -1) from +=
         * ",IN (_pws.pwsFacility) _pwsFacility "; if
         * (where.indexOf("pwsMonitor.") > -1) from +=
         * ",IN (_pws.pwsMonitor) _pwsMonitor ";
         */
