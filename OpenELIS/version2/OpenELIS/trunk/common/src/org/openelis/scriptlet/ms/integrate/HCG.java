...
/**
 * The class that stores data for HCG; it also computes weight adjustment factor
 * for MoM and median based on gestational age
 */
public class HCG extends Test {
    public HCG() {
        super(1.15, 1.0, new Double[] {0.0, 0.0}, new Double[] {.4, 5.0}, new Double[] {.2, 2.5},
              105, 146, Messages.get().scriptlet_hcg());
    }
