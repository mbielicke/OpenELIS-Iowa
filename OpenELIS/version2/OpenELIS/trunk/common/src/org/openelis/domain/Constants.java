...
public class Constants implements Serializable {
    ...
    public static class Dictionary implements Serializable {
        ...
        public Integer            ANALYSIS_CANCELLED, ANALYSIS_COMPLETED, ANALYSIS_ERROR_COMPLETED,
                        ...
                        ORG_FINALREP_FAX_NUMBER, ORG_GENERAL_FAX_NUMBER, ORG_NO_FINALREPORT,
                        ORG_REPORT_TO, ORG_SECOND_REPORT_TO, PATIENT_RELATION_MOTHER,
                        PATIENT_RELATION_FATHER, PATIENT_RELATION_GUARDIAN, PATIENT_RELATION_SELF,
                        POS_DUPLICATE, POS_FIXED, POS_FIXED_ALWAYS, POS_RANDOM, POS_LAST_OF_SUBSET,
                        POS_LAST_OF_RUN, POS_LAST_OF_SUBSET_AND_RUN, POS_REAGENT_MEDIA,
                        PROFILE_AIR_STRING, PROFILE_ORDER_IN, PT_SAMPLE, QAEVENT_INTERNAL,
                        ...
                        RESULT_FLAG_ABNORMAL, RESULT_FLAG_ABNORMAL_CDC, RESULT_FLAG_ABNORMAL_DNR,
                        RESULT_FLAG_ABNORMAL_DPH, RESULT_FLAG_CDC, RESULT_FLAG_DNR,
