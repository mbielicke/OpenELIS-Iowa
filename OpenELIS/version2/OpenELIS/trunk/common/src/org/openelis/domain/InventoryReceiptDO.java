...
public class InventoryReceiptDO implements RPC {
    ...
    protected String          fromItemStore;
    protected String          fromitemDispensedUnits;
    protected Integer         parentRatio;
    protected Integer         childRatio;
    ...
    public InventoryReceiptDO(Integer id,
...
//        setStorageLocation(DataBaseUtil.formatStorageLocation(storageLocName, storageLocLocation, storageUnitDescription));
    ...
    public InventoryReceiptDO(Integer id,
                              ...
                              String fromStore,
                              String fromDisUnits,
                              Integer fromStorageLocationId,
                              String fromStorageLocName,
                              String fromStorageUnitDescription,
                              String fromStorageLocLocation,
                              Integer fromQtyOnHand) {
        setId(id);
        setOrderNumber(orderNumber);
        setReceivedDate(dateReceived);
        setUpc(upc);
...
//        setFromStorageLocation(DataBaseUtil.formatStorageLocation(fromStorageLocName, fromStorageLocLocation, fromStorageUnitDescription));
    ...
    public InventoryReceiptDO(Integer orderNumber,
                              Integer inventoryItemId,
                              String inventoryItem,
                              Integer orderItemId,
                              Double unitCost,
    ...
    public Integer getChildRatio() {
        return childRatio;
    }

    public void setChildRatio(Integer childRatio) {
        this.childRatio = childRatio;
    }

    public String getFromItemStore() {
        return fromItemStore;
    }

    public void setFromItemStore(String fromItemStore) {
        this.fromItemStore = fromItemStore;
    }

    public String getFromitemDispensedUnits() {
        return fromitemDispensedUnits;
    }

    public void setFromitemDispensedUnits(String fromitemDispensedUnits) {
        this.fromitemDispensedUnits = DataBaseUtil.trim(fromitemDispensedUnits);
    }
}
