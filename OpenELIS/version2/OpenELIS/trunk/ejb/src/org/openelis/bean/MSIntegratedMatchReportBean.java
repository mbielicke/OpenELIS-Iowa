...
public class MSIntegratedMatchReportBean {
    ...
    public ReportStatus runReport(ArrayList<QueryData> paramList) throws Exception {
        ...
        JasperPrint jprint;
        String printer, printstat, userName;
        /*
         * push status into session so we can query it while the report is
         * running
         */
        status = new ReportStatus();
        session.setAttribute("MSIntegratedMatchReport", status);
        ...
        try {
            ...
            url = ReportUtil.getResourceURL("org/openelis/report/msIntegratedMatch/main.jasper");
    ...
    private Path export(JasperPrint print, String systemVariableDirectory, String printer) throws Exception {
        ...
        try {
            if ("-csv-".equals(printer)) {
                ...
                path = ReportUtil.createTempFile("msIntegratedMatch", ".csv", systemVariableDirectory);
            } else {
                jexport = new JRPdfExporter();
                path = ReportUtil.createTempFile("msIntegratedMatch", ".pdf", systemVariableDirectory);
            }
            ...
            try {
                ...
                log.severe("Could not close outout stream for ms integrated match report");
            }
        }
