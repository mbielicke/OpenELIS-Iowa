...
public class MCLViolationReportBean implements MCLViolationReportLocal,
                                   MCLViolationReportRemote {
    @EJB
    ...
    public ReportStatus runReport(ArrayList<QueryData> paramList) throws Exception {
        ...
        try {
            ...
            try {
                analysisList = analysisBean.fetchForMCLViolationReport(lastRunDate,
                                                                       currentRunDate);
            ...
            for (i = 0; i < analysisList.size(); i++ ) {
                ...
                try {
                    resultBean.fetchByAnalysisIdForDisplay(analysis.getAnalysisId(),
                                                           results);
                } catch (NotFoundException nfE) {
                    log.severe("Analysis (" + analysis.getAnalysisId() +
                               ") is missing results.");
                    continue;
                }
                    ...
                    if ( !DataBaseUtil.isEmpty(rowResult.getValue())) {
                        for (k = 1; k < resultRow.size(); k++ ) {
                            ...
                            if ("mcl".equals(analyte.getExternalId()) &&
                                !DataBaseUtil.isEmpty(colResult.getValue())) {
                                resultSign = null;
    ...
    protected void printHeader(StringBuilder body, MCLViolationReportVO analysis) {
        body.append("\r\n")
            ...
            .append("OE")
            .append(analysis.getAccessionNumber())
            .append("<br>\r\n")
            .append("PWS ID: ")
            .append(analysis.getPwsId())
            .append("<br>\r\n")
            .append("Client: ")
            .append(analysis.getOrganizationName())
            .append("<br>\r\n")
            .append("Test: ")
            ...
            .append("<br>\r\n")
            .append("Unit: ")
            .append(analysis.getUnitDescription())
            .append("<br>\r\n")
            .append("Start of Analysis: ")
            .append(ReportUtil.toString(analysis.getAnaStartedDate(), "yyyy-MM-dd HH:mm"))
            .append("<br>\r\n")
            .append("Analysis Released: ")
            .append(ReportUtil.toString(analysis.getAnaReleasedDate(), "yyyy-MM-dd HH:mm"))
            .append("<br>\r\n")
            .append("<br>\r\n")
    ...
    protected void printResultRow(StringBuilder body, MCLViolationReportVO analysis,
        ...
        body.append("    <tr><td>")
            .append(rowResult.getAnalyte())
            .append("</td>")
            .append("<td>")
            .append(rowResult.getValue())
            .append("</td>")
            .append("<td>")
            .append(getAdjustedResult(rowResult, analysis))
            .append("</td>")
            .append("<td>")
            .append(mclResult.getValue())
            .append("</td></tr>\r\n");
    }
    ...
    protected void printDNR(StringBuilder body, MCLViolationReportVO analysis,
        ...
        for (i = 0; i < adMan.count(); i++ ) {
            ...
            if ("pb_type".equals(auxDataVDO.getAnalyteExternalId())) {
                try {
                    pbSampleType = dictionaryCache.getById(Integer.valueOf(auxDataVDO.getValue()))
                                                  .getCode();
        ...
        body.append("<br>\r\n")
            .append("Sample Point ID ")
            .append(analysis.getSamplePointId())
            .append("<br>\r\n")
        ...
        body.append("<br>\r\n")
            .append("Sample Type ")
            .append(analysis.getSampleType().substring(0, 2))
            .append("<br>\r\n")
            .append("PB Sample Type ")
            .append(pbSampleType)
            .append("<br>\r\n")
            .append("Original Sample # ")
            .append(origSampleNumber)
            .append("<br>\r\n")
            .append("Sample Collection Date ")
            .append(ReportUtil.toString(analysis.getCollectionDate(), "yyyy-MM-dd"));

        if (analysis.getCollectionTime() != null)
            body.append(" ").append(ReportUtil.toString(analysis.getCollectionTime(),
                                                        "HH:mm"));
        ...
        body.append("<br>\r\n")
            ...
            .append(analysis.getAccessionNumber())
            .append("<br>\r\n")
            .append("Contaminant ID ")
            .append(contaminantIds.get(rowResult.getAnalyte()))
            .append("<br>\r\n")
            .append("Contaminant Name ")
            .append(rowResult.getAnalyte())
            .append("<br>\r\n")
            .append("Method Code ")
            .append(methodCodes.get(analysis.getMethodName()))
            .append("<br>\r\n")
            .append("Start of Analysis ")
            .append(ReportUtil.toString(analysis.getAnaStartedDate(), "yyyy-MM-dd HH:mm"))
            .append("<br>\r\n")
    ...
    protected String getAdjustedResult(ResultViewDO result, MCLViolationReportVO analysis) {
        ...
        if (Constants.dictionary().MICROGRAMS_PER_LITER.equals(analysis.getUnitOfMeasureId()) ||
            Constants.dictionary().NANOGRAMS_PER_MILLILITER.equals(analysis.getUnitOfMeasureId())) {
            bdValue = bdValue.divide(new BigDecimal(1000.0));
        } else if (Constants.dictionary().NANOGRAMS_PER_LITER.equals(analysis.getUnitOfMeasureId())) {
