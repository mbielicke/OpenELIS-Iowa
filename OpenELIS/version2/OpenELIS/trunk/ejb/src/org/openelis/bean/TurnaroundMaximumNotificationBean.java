                ...
                for (Integer aId : analysisIds) {
                    ...
                    if (!prevSectId.equals(aVDO.getSectionId())) {
                        if (prevSectId != -1) {
                            ...
                            sendEmail(toEmail, "Turnaround Maximum Notification: "+prevSectName, contents.toString());
                            toEmail = "";
                        ...
                        try {
                            ...
                            log.fine("No Turnaround Max Email Address(es) for Section ("+aVDO.getSectionName()+").");
                            continue;
                        }
