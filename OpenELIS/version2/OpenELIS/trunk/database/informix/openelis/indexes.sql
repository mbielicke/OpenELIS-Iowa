...
create        index analysis_1_idx on analysis (id);
...
create unique index aux_field_grp_1_idx on aux_field_group (id);
create        index aux_field_grp_2_idx on aux_field_group (name);

create unique index aux_field_val_1_idx on aux_field_value (id);
create        index aux_field_val_2_idx on aux_field_value (aux_field_id);
...
create unique index lock_1_idx on lock (reference_id, reference_table_id);
...
create        index provider_location_4_idx on provider_location (provider_id);
...
create unique index samp_private_well_1_idx on sample_private_well (id);
create unique index samp_private_well_2_idx on sample_private_well (sample_id);
create        index samp_private_well_3_idx on sample_private_well (organization_id);
...
create        index sample_sdwis_2_idx on sample_sdwis (sample_id);
create        index sample_sdwis_3_idx on sample_sdwis (pws_id);

create unique index scriptlet_1_idx on scriptlet (id);
create unique index scriptlet_2_idx on scriptlet (name);
...
create unique index stand_note_1_idx on standard_note (id);
create        index stand_note_2_idx on standard_note (name);

create unique index storage_1_idx on storage (id);
create        index storage_2_idx on storage (reference_id, reference_table_id);

create unique index storage_loc_1_idx on storage_location (id);
create        index storage_loc_2_idx on storage_location (name);
...
create        index test_worksheet_2_idx on test_worksheet (test_id);
...
create unique index test_worksheet_itm_1_idx on test_worksheet_item (id);
create        index test_worksheet_itm_2_idx on test_worksheet_item (test_worksheet_id);
...
create        index worksheet_reagent_1_idx on worksheet_reagent (id);
