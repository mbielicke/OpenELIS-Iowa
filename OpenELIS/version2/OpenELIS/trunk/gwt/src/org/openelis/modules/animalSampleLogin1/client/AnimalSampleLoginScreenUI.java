...
public class AnimalSampleLoginScreenUI extends Screen implements CacheProvider {

    @UiTemplate("AnimalSampleLogin.ui.xml")
    interface AnimalSampleLoginUiBinder extends UiBinder<Widget, AnimalSampleLoginScreenUI> {
    };

    private static AnimalSampleLoginUiBinder            uiBinder   = GWT.create(AnimalSampleLoginUiBinder.class);
    ...
    @UiField
    protected TextBox<String>                           clientReference, location,
                    locationAddressMultipleUnit, locationAddressStreetAddress, locationAddressCity,
                    locationAddressZipCode, providerFirstName, providerPhone;

    @UiField
    protected Dropdown<Integer>                         status, animalCommonName,
    ...
    protected MenuItem                                  duplicate, historySample,
                    historySampleAnimal, historySampleOrganization,
    ...
    protected AnimalSampleLoginScreenUI                 screen;
     ...
     */
    public AnimalSampleLoginScreenUI(WindowInt window) throws Exception {
        setWindow(window);

        if (UserCache.getPermission().getModule("sampleanimal") == null)
            throw new PermissionException(Messages.get()
                                                  .screenPermException("Animal Sample Login Screen"));
        ...
        logger.fine("Animal Sample Login Screen Opened");
    }
    ...
    private void initialize() {
        ...
        addStateChangeHandler(new StateChangeEvent.Handler() {
            public void onStateChange(StateChangeEvent event) {
                historySampleAnimal.setEnabled(isState(DISPLAY));
            }
        });

        historySampleAnimal.addCommand(new Command() {
            @Override
            public void execute() {
        ...
        addScreenHandler(clientReference,
                         ...
                         new ScreenHandler<String>() {
                             ...
                             public Widget onTab(boolean forward) {
                                 return forward ? animalCommonName : status;
                             }
                         });
        ...
        addScreenHandler(animalCommonName,
                         ...
                         new ScreenHandler<Integer>() {
                             ...
                             public void onValueChange(ValueChangeEvent<Integer> event) {
                                 ...
                                 runScriptlets(null, SampleMeta.getAnimalAnimalCommonNameId(), null);
                             }
                             ...
                             public Widget onTab(boolean forward) {
                                 return forward ? animalScientificName : clientReference;
                             }
                         });

        animalCommonName.addKeyUpHandler(new KeyUpHandler() {
            @Override
            public void onKeyUp(KeyUpEvent event) {
                Integer nameId;

                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    nameId = previousManager.getSampleAnimal().getAnimalCommonNameId();
                    setAnimalCommonNameId(nameId);
                    animalCommonName.setValue(nameId);
                    screen.focusNextWidget((Focusable)animalCommonName, true);
                    event.preventDefault();
                    event.stopPropagation();
                }
            }
        ...
        animalScientificName.addKeyUpHandler(new KeyUpHandler() {
            @Override
            public void onKeyUp(KeyUpEvent event) {
                Integer nameId;

                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    nameId = previousManager.getSampleAnimal().getAnimalScientificNameId();
                    setAnimalScientificNameId(nameId);
                    animalScientificName.setValue(nameId);
                    screen.focusNextWidget((Focusable)animalScientificName, true);
                    event.preventDefault();
                    event.stopPropagation();
                }
            }
        ...
        addScreenHandler(location, SampleMeta.getAnimalLocation(), new ScreenHandler<String>() {
            ...
            public void onValueChange(ValueChangeEvent<String> event) {
                ...
                runScriptlets(null, SampleMeta.getAnimalLocation(), null);
            }
        ...
        location.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                ...
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    l = previousManager.getSampleAnimal().getLocation();
                    setLocation(l);
                    location.setValue(l);
        ...
        locationAddressMultipleUnit.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                ...
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    mu = previousManager.getSampleAnimal().getLocationAddress().getMultipleUnit();
        ...
        locationAddressStreetAddress.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                ...
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    sa = previousManager.getSampleAnimal().getLocationAddress().getStreetAddress();
        ...
        addScreenHandler(locationAddressCity,
                         ...
                         new ScreenHandler<String>() {
                             ...
                             public void onValueChange(ValueChangeEvent<String> event) {
                                 ...
                                 runScriptlets(null, SampleMeta.getAnimalLocationAddrCity(), null);
                             }
        ...
        locationAddressCity.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                ...
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    c = previousManager.getSampleAnimal().getLocationAddress().getCity();
        ...
        addScreenHandler(locationAddressState,
                         ...
                         new ScreenHandler<String>() {
                             ...
                             public void onValueChange(ValueChangeEvent<String> event) {
                                 ...
                                 runScriptlets(null, SampleMeta.getAnimalLocationAddrState(), null);
                             }
        ...
        locationAddressState.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                ...
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    s = previousManager.getSampleAnimal().getLocationAddress().getState();
        ...
        locationAddressZipCode.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                ...
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    zip = previousManager.getSampleAnimal().getLocationAddress().getZipCode();
        ...
        addScreenHandler(providerLastName,
                         ...
                         new ScreenHandler<AutoCompleteValue>() {
                             ...
                             public void onValueChange(ValueChangeEvent<AutoCompleteValue> event) {
                                 ...
                                 setProvider(data);
                                 runScriptlets(null, SampleMeta.getAnimalProviderLastName(), null);
                             }
        ...
        providerLastName.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    setProvider(previousManager.getSampleAnimal().getProvider());
        ...
        providerPhone.addKeyUpHandler(new KeyUpHandler() {
            ...
            public void onKeyUp(KeyUpEvent event) {
                ...
                if (canCopyFromPrevious(event.getNativeKeyCode())) {
                    phone = previousManager.getSampleAnimal().getProviderPhone();
        ...
        /*
         * call for putting the screen in add state and loading it with a new
         * manager
         */
        if (addCall == null) {
        ...
        if (fetchForUpdateCall == null) {
            fetchForUpdateCall = new AsyncCallbackUI<SampleManager1>() {
                public void success(SampleManager1 result) {
                    manager = result;
                    if ( !Constants.domain().ANIMAL.equals(manager.getSample().getDomain())) {
                        /*
                    ...
                    // if (manager.getSampleAnimal().getPatientId() == null)
                    // manager.getSampleAnimal().setPatient(new PatientDO());
                    buildCache();
                    evaluateEdit();
                    setData();
                    setState(UPDATE);
            ...
            unlockCall = new AsyncCallbackUI<SampleManager1>() {
                public void success(SampleManager1 result) {
                    ...
                    if (Constants.domain().QUICKENTRY.equals(manager.getSample().getDomain())) {
                        /*
                         * the screen was loaded from a quick-entry sample, so
                         * that data can't be shown anymore
                         */
                        manager = null;
                        st = DEFAULT;
                    } else {
        ...
        /*
         * call for duplicating the manager on the screen
         */
        if (duplicateCall == null) {
            duplicateCall = new AsyncCallbackUI<SampleTestReturnVO>() {
                public void success(SampleTestReturnVO result) {
                    ...
                    if ( !Constants.domain().ANIMAL.equals(result.getManager()
                                                                 .getSample()
                                                                 .getDomain())) {
                        /*
                         * the sample's domain may have changed after it was
        ...
        /*
         * call for loading a quick-entered sample on the screen
         */
        ...
        /*
         * call for validating the accession number entered by the user
         */
        ...
        /*
         * call for loading the screen with a manager filled from an order
         */
            ...
            public void executeQuery(final Query query) {
                ...
                if (queryCall == null) {
                    queryCall = new AsyncCallbackUI<ArrayList<IdAccessionVO>>() {
                        ...
                        public void failure(Throwable e) {
                            setQueryResult(null);
                            Window.alert("Error: Animal Login call query failed; " + e.getMessage());
                            logger.log(Level.SEVERE, e.getMessage(), e);
    ...
    protected void add(ClickEvent event) {
        setBusy();
        SampleService1.get().getInstance(Constants.domain().ANIMAL, addCall);
    }
    ...
    private void displayAttachment(Integer id, boolean isSameWindow) {
         ...
         */
        name = isSameWindow ? Messages.get().sampleAnimal_login() : null;
        try {
