            ...
            <HorizontalPanel width="100%">
              <TablePanel style="Form">
                ...
                <row>
                  ...
                  <textbox key="{meta:getWellReportToAddressFaxPhone()}" width="100" max="16" tab="{meta:getWellLocation()},{meta:getWellReportToAddressWorkPhone()}" mask="{resource:getString($constants,'phonePattern')}" field="String" />
                </row>
                <row></row>
              </TablePanel>
              <TablePanel style="Form">
                ...
                <row>
                  ...
                  <textbox key="{meta:getWellLocationAddrZipCode()}" width="73" mask="99999-9999" max="10" tab="{meta:getWellOwner()},{meta:getWellLocationAddrState()}" field="String" />
                </row>
              </TablePanel>
            </HorizontalPanel>
          </VerticalPanel>
            ...
            <VerticalPanel style="subform">
              ...
              <TablePanel style="Form">
                ...
                <row>
                  ...
                  <HorizontalPanel>
                    <autoComplete key="{meta:getBillTo()}" width="182" case="UPPER" popWidth="auto" tab="itemsTestsTree,{meta:getProjectName()}" field="Integer">
                      <col width="200" header="{resource:getString($constants,'name')}" />
                      <col width="130" header="{resource:getString($constants,'street')}" />
                      <col width="120" header="{resource:getString($constants,'city')}" />
                      <col width="20" header="{resource:getString($constants,'st')}" />
