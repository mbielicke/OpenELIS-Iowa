...
public class TestWorksheetItemTypeCacheHandler implements
    ...
    public void handle(TestWorksheetItemTypeCacheMessage message) {
        CachingManager.remove("InitialData", "testWorksheetItemTypeDropDown");
    }
    
    public static TableDataModel<TableDataRow<Integer>> getTestWorksheetItemTypes() {
