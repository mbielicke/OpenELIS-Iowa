...
<screen id="Organization" name="Inventory Receipt" serviceUrl="ElisService" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<display>
		...
		<!--end button panel-->
			...
			<panel layout="horizontal" xsi:type="Panel">
								...
								<row>
									...
									<widget colspan="3">
										<autoDropdown key="" case="lower" width="172px" popWidth="auto" tab="??,??">
													<widths>167</widths>
										</autoDropdown>
									</widget>
								</row>-->
								...
								<row>
									...
									<!--<widget style="WhiteContentPanel" halign="center">									
									<appButton action="addToExisiting" onclick="this" toggle="true" style="Button" key="removeContactButton">
									<panel xsi:type="Panel" layout="horizontal">
              						<panel xsi:type="Absolute" layout="absolute" style="AddButtonImage"/>
						             <widget>
                						<text>Add To Existing</text>
							              </widget>
							              </panel>
						            </appButton>
						            </widget>-->
