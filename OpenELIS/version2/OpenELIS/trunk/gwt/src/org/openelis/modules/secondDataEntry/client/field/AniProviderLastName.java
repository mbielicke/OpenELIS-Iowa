...
/**
 * This class manages the widgets used for verifying animal provider
 */
public class AniProviderLastName extends SingleField<AutoComplete> {
    private TextArea providerFirstName, providerFirstName1;

    public AniProviderLastName(VerificationScreen parentScreen, TableRowElement tableRowElement,
    ...
    protected void init() {
        ...
        key = SampleMeta.ANI_PROVIDER_LAST_NAME;
    ...
    /**
     * Copies animal provider from the manager to the editable widget
     */
    public void copyFromSample() {
        ...
        data = parentScreen.getManager().getSampleAnimal();
    ...
    /**
     * Copies animal provider from the editable widget to the manager
     */
     ...
     * sample's animal provider last name; increments the number of times the
     * value has been changed; if the values are different and the value has
     * been changed more than once, shows the sample's animal provider to the
     * user
     */
    public void valueChanged() {
        ...
        if ( !isVerified) {
            ...
            if (numEdit > 1) {
                sprov = parentScreen.getManager().getSampleAnimal().getProvider();
