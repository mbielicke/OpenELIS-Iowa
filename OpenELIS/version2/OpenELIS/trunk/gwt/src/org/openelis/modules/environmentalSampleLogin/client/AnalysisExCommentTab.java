...
public class AnalysisExCommentTab extends NotesTab {

    protected AnalysisTestDO analysis;
    protected AnalysisManager anMan;
    
    public AnalysisExCommentTab(ScreenDefInt def, String notesPanelKey, String editButtonKey, boolean isExternal) {
