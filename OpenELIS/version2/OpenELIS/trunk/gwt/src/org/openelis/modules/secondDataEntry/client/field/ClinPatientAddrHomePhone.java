 ...
 * home phone
 */
public class ClinPatientAddrHomePhone extends SingleField<TextBox<String>> {
    public ClinPatientAddrHomePhone(VerificationScreen parentScreen,
    ...
    protected void init() {
        ...
        key = SampleMeta.CLIN_PATIENT_ADDR_HOME_PHONE;
    ...
    /**
     * Copies clinical patient address home phone from the manager to the
     * editable widget
     */
    public void copyFromSample() {
        ...
        if (numEdit > 1 &&
            DataBaseUtil.isDifferent(editableWidget.getValue(), sm.getSampleClinical()
                                                                  ...
                                                                  .getAddress()
                                                                  .getHomePhone())) {
            editableWidget.setValue(sm.getSampleClinical().getPatient().getAddress().getHomePhone());
    ...
    /**
     * Copies clinical patient address home phone from the editable widget to
     * the manager
     */
    public void copyToSample() {
        ...
        if (numEdit > 1 &&
            ...
            DataBaseUtil.isDifferent(phone, sm.getSampleClinical()
                                              .getPatient()
                                              .getAddress()
                                              .getHomePhone())) {
            sm.getSampleClinical().getPatient().getAddress().setHomePhone(phone);
     ...
     * sample's clinical patient address home phone; increments the number of
     ...
     * patient address home phone to the user
     */
    ...
    /**
     * Verifies whether the value entered by the user is the same as the
     * sample's clinical patient address home phone
     */
    public void verify() {
