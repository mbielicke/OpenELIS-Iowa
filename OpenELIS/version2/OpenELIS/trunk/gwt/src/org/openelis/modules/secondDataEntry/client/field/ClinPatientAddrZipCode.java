 ...
 * zip code
 */
public class ClinPatientAddrZipCode extends SingleField<TextBox<String>> {
    public ClinPatientAddrZipCode(VerificationScreen parentScreen, TableRowElement tableRowElement,
    ...
    protected void init() {
        ...
        key = SampleMeta.CLIN_PATIENT_ADDR_ZIP_CODE;
        ...
        parentScreen.getEventBus().addHandler(PatientChangeEvent.getType(),
                                              new PatientChangeEvent.Handler() {
                                                  ...
                                                  public void onPatientChange(PatientChangeEvent event) {
                                                       ...
                                                       * new patient's zip code;
                                                       * if the previous
                                                       * patient's zip code was
    ...
    /**
     * Copies clinical patient address zip code from the manager to the editable
     * widget
     */
    public void copyFromSample() {
        ...
        if (numEdit > 1 &&
            DataBaseUtil.isDifferent(editableWidget.getValue(), sm.getSampleClinical()
                                                                  ...
                                                                  .getAddress()
                                                                  .getZipCode())) {
            editableWidget.setValue(sm.getSampleClinical().getPatient().getAddress().getZipCode());
    ...
    public void copyToSample() {
        ...
        if (numEdit > 1 &&
            ...
            DataBaseUtil.isDifferent(zip, sm.getSampleClinical()
                                            .getPatient()
                                            .getAddress()
                                            .getZipCode())) {
            sm.getSampleClinical().getPatient().getAddress().setZipCode(zip);
     ...
     * sample's clinical patient address zip code; increments the number of
     ...
     * patient address zip code to the user
     */
    ...
    /**
     * Verifies whether the value entered by the user is the same as the
     * sample's clinical patient address zip code
     */
    public void verify() {
