...
<xsl:stylesheet version="1.0" extension-element-prefixes="resource"
	xmlns:locale="xalan://java.util.Locale" xmlns:resource="xalan://org.openelis.util.UTFResource"
	...
	<xsl:template match="doc">
		...
		<screen xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
			id="SampleTreePopout" name="{resource:getString($constants,'itemsAndAnalyses')}">
			<VerticalPanel padding="0" spacing="0">
				<tree key="itemsTestsTree" width="auto" maxRows="25" showScroll="ALWAYS">
					...
					<leaf key="analysis">
						...
						<col>
							<dropdown width="110px" case="LOWER" popWidth="110px"
								field="String" />
						</col>
					</leaf>
				</tree>
