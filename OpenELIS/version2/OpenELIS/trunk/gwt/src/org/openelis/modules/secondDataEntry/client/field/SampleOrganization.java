    ...
    protected void init() {
        ...
        parentScreen.addScreenHandler(editableWidget, key, new ScreenHandler<AutoCompleteValue>() {
            ...
            public void onValueChange(ValueChangeEvent<AutoCompleteValue> event) {
                ...
                /*
                 * update the number of times the widget has been edited
                 */
                numEdit++ ;
                ...
                /*
                 * verify whether the value entered is different from the one in
                 * the manager; if it is and this widget has been edited
                 * multiple times, show the value in the manager in the widget
                 * on the right; blank the icon for the direction of copy
                 * because the current value was not copied to or from the
                 * manager
                 */
                verify();
                if ( !isVerified) {
