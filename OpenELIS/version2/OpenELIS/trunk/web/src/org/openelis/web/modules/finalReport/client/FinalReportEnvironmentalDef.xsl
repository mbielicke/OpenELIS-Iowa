    ...
    <DeckPanel key="deck" height = "100%" width = "100%">
	 ...
	 <TablePanel width = "100%">
	  ...
	  <VerticalPanel padding="0" spacing="0" style="WhiteContentPanel">             
          <VerticalPanel>           
              <widget valign="top">
                <table key="sampleEntTable" width="820" maxRows="12"  style="ScreenTableWithSides" showScroll="ALWAYS" title="">
                  ...
                  <col key="project" width="120" header="{resource:getString($constants,'projectCode')}">
                    <textbox field="String" />
                  </col>                        
                </table>
              </widget>
