...
<xsl:stylesheet
  ...
  <xsl:template match="doc">
    ...
    <DeckPanel key="deck" height = "100%" width = "100%">
      ...
      <VerticalPanel>
      	<text style="FormTitle">Released date </text>
      	<text> Date the analysis gets released at SHL </text>
      	<text style="FormTitle">Accession Number</text>
      	<text> SHL assigned unique number to a particular sample </text>
      	<text style="FormTitle">Client Reference: </text>
      	<text> Any information that links the sample at the client end </text>
      </VerticalPanel>
      </HorizontalPanel>
	  </deck>
	  <deck>
