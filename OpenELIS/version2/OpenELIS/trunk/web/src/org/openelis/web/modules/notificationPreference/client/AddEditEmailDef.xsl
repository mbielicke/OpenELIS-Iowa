...
<xsl:stylesheet
  ...
  <xsl:template match="doc">
    <screen id="AddEditEmail" name="AddEditEmail">
      <VerticalPanel padding="0" spacing="0" style="BluePopUpPanel">
        <TablePanel style="Form">
          <row>
            ...
            <dropdown field="Integer" key="organization" tab="forReceived, email" width="250" />
          </row>
          <row>
            <widget align="right">
              <text>
                <xsl:value-of select='resource:getString($constants,"forRecSamples")' />:
              </text>
            </widget>
            <check key="forReceived" tab="forReleased, organization" />
          </row>
          <row>
            <widget align="right">
              <text>
                <xsl:value-of select='resource:getString($constants,"forRelSamples")' />:
              </text>
            </widget>
            <check key="forReleased" tab="email, forReceived" />
          </row>
          <row>
            <widget align="right">
              <text>
