...
public interface PortalMessages extends org.openelis.ui.messages.UIMessages {
  ...
  /**
   * Translated "<span class=\"helpText\"><span class=\"helpHeader\">Locating Your Results</span><br/><p/>You only need to enter information in one field to conduct a search for your results. Example fields include: <b>Accession Number</b> or <b>Patient''s Last Name</b><p/>It is recommended that you use the calendar to the right of each date field when entering a date to eliminate any formatting errors. You must click out of the calendar to enter the selected date. All dates have the format of YYYY-MM-DD.<p/>The system supports wild card searches in the following fields: <b>Client Reference</b>, <b>Patient''s First Name</b>, and <b>Patient''s Last Name</b>. To use this search method add an * at the beginning and/or end of your search term. Below are three examples: <ul><li> To see a list of reports for a patient whose last name starts with the letters schm, enter schm* in the <b>Patient''s Last Name</b> field. Matches would include: schmidt, schmitt, schmitz, etc.</li><li> To see a list of reports for a patient whose first name ends with the letters jo, enter *jo in the <b>Patient''s First Name</b> field. Matches would include: betty jo, bettyjo, jo, etc.</li></ul><p/>Click the <b>Find Samples</b> button to display a list of samples that match your search criteria. The <b>Reset</b> button clears all of the search fields.</span>".
   * 
   * @return translated "<span class=\"helpText\"><span class=\"helpHeader\">Locating Your Results</span><br/><p/>You only need to enter information in one field to conduct a search for your results. Example fields include: <b>Accession Number</b> or <b>Patient''s Last Name</b><p/>It is recommended that you use the calendar to the right of each date field when entering a date to eliminate any formatting errors. You must click out of the calendar to enter the selected date. All dates have the format of YYYY-MM-DD.<p/>The system supports wild card searches in the following fields: <b>Client Reference</b>, <b>Patient''s First Name</b>, and <b>Patient''s Last Name</b>. To use this search method add an * at the beginning and/or end of your search term. Below are three examples: <ul><li> To see a list of reports for a patient whose last name starts with the letters schm, enter schm* in the <b>Patient''s Last Name</b> field. Matches would include: schmidt, schmitt, schmitz, etc.</li><li> To see a list of reports for a patient whose first name ends with the letters jo, enter *jo in the <b>Patient''s First Name</b> field. Matches would include: betty jo, bettyjo, jo, etc.</li></ul><p/>Click the <b>Find Samples</b> button to display a list of samples that match your search criteria. The <b>Reset</b> button clears all of the search fields.</span>"
   */
  @DefaultMessage("<span class=\"helpText\"><span class=\"helpHeader\">Locating Your Results</span><br/><p/>You only need to enter information in one field to conduct a search for your results. Example fields include: <b>Accession Number</b> or <b>Patient''s Last Name</b><p/>It is recommended that you use the calendar to the right of each date field when entering a date to eliminate any formatting errors. You must click out of the calendar to enter the selected date. All dates have the format of YYYY-MM-DD.<p/>The system supports wild card searches in the following fields: <b>Client Reference</b>, <b>Patient''s First Name</b>, and <b>Patient''s Last Name</b>. To use this search method add an * at the beginning and/or end of your search term. Below are three examples: <ul><li> To see a list of reports for a patient whose last name starts with the letters schm, enter schm* in the <b>Patient''s Last Name</b> field. Matches would include: schmidt, schmitt, schmitz, etc.</li><li> To see a list of reports for a patient whose first name ends with the letters jo, enter *jo in the <b>Patient''s First Name</b> field. Matches would include: betty jo, bettyjo, jo, etc.</li></ul><p/>Click the <b>Find Samples</b> button to display a list of samples that match your search criteria. The <b>Reset</b> button clears all of the search fields.</span>")
  @Key("finalReport.audited.help.screen")
  String finalReport_audited_help_screen();
  ...
  /**
   * Translated "Audited Final Report".
   * 
   * @return translated "Audited Final Report"
   */
  @DefaultMessage("Audited Final Report")
  @Key("main.auditedFinalReport")
  String main_auditedFinalReport();
   ...
   * Translated "Audited\nFinal Report".
   * 
   * @return translated "Audited\nFinal Report"
   */
  @DefaultMessage("Audited\nFinal Report")
  @Key("main.menu.auditedFinalReport")
  String main_menu_auditedFinalReport();
