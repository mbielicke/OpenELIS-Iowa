...
public interface PortalMessages extends org.openelis.ui.messages.UIMessages {
  ...
  /**
   * Translated "Status of Samples".
   * 
   * @return translated "Status of Samples"
   */
  @DefaultMessage("Status of Samples")
