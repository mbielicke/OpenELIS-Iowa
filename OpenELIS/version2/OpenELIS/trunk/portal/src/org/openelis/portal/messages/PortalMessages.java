...
public interface PortalMessages extends org.openelis.ui.messages.UIMessages {
  ...
  /**
   * Translated "<span class = \"helpText\"><span class = \"helpHeader\"> Locating Your Result </span><ul><li>To locate <span class = \"helpBoldText\">Test Analytes</span> and <span class = \"helpBoldText\">Auxiliary Data</span>, enter information in one or more search fields. It is recommended that you use the provided calendars to the right of these fields when inputting dates to eliminate any formatting errors. Click on <span class = \"helpBoldText\">Today</span> at the bottom of the calendar to enter today''s date.<li>The system supports wild card searches only in the following fields: <span class = \"helpBoldText\">Collector Name</span>, <span class = \"helpBoldText\">Client Reference</span>, <span class = \"helpBoldText\">Collection Site</span>, and <span class = \"helpBoldText\">Collection Town</span>.  By using this search method you would add \"*\" at the end of your search term. For example, to see a list of samples that share the first three letters \"BIG\", enter \"BIG*\".  Matches would include \"BIG WATER\", \"BIG RIVER\", \"BIGGER THAN SKY\", etc.</li><li>You may also narrow your search by entering information in multiple fields.</li><li>Click the <span class = \"helpBoldText\">Continue to Report Fields</span> button to view a list of available report fields for sample, organization, and analysis information.</li></ul><span class = \"helpHeader\"> Disclaimer: </span> <ul> <li>Results from this report represent analytical values as of the date they are generated.  Future revisions may affect these results and official final results should be reviewed from the <span class = \"helpBoldText\">Environmental Final Report</span> function to assure their accuracy.</li></ul></span>".
   * 
   * @return translated "<span class = \"helpText\"><span class = \"helpHeader\"> Locating Your Result </span><ul><li>To locate <span class = \"helpBoldText\">Test Analytes</span> and <span class = \"helpBoldText\">Auxiliary Data</span>, enter information in one or more search fields. It is recommended that you use the provided calendars to the right of these fields when inputting dates to eliminate any formatting errors. Click on <span class = \"helpBoldText\">Today</span> at the bottom of the calendar to enter today''s date.<li>The system supports wild card searches only in the following fields: <span class = \"helpBoldText\">Collector Name</span>, <span class = \"helpBoldText\">Client Reference</span>, <span class = \"helpBoldText\">Collection Site</span>, and <span class = \"helpBoldText\">Collection Town</span>.  By using this search method you would add \"*\" at the end of your search term. For example, to see a list of samples that share the first three letters \"BIG\", enter \"BIG*\".  Matches would include \"BIG WATER\", \"BIG RIVER\", \"BIGGER THAN SKY\", etc.</li><li>You may also narrow your search by entering information in multiple fields.</li><li>Click the <span class = \"helpBoldText\">Continue to Report Fields</span> button to view a list of available report fields for sample, organization, and analysis information.</li></ul><span class = \"helpHeader\"> Disclaimer: </span> <ul> <li>Results from this report represent analytical values as of the date they are generated.  Future revisions may affect these results and official final results should be reviewed from the <span class = \"helpBoldText\">Environmental Final Report</span> function to assure their accuracy.</li></ul></span>"
   */
  @DefaultMessage("<span class = \"helpText\"><span class = \"helpHeader\"> Locating Your Result </span><ul><li>To locate <span class = \"helpBoldText\">Test Analytes</span> and <span class = \"helpBoldText\">Auxiliary Data</span>, enter information in one or more search fields. It is recommended that you use the provided calendars to the right of these fields when inputting dates to eliminate any formatting errors. Click on <span class = \"helpBoldText\">Today</span> at the bottom of the calendar to enter today''s date.<li>The system supports wild card searches only in the following fields: <span class = \"helpBoldText\">Collector Name</span>, <span class = \"helpBoldText\">Client Reference</span>, <span class = \"helpBoldText\">Collection Site</span>, and <span class = \"helpBoldText\">Collection Town</span>.  By using this search method you would add \"*\" at the end of your search term. For example, to see a list of samples that share the first three letters \"BIG\", enter \"BIG*\".  Matches would include \"BIG WATER\", \"BIG RIVER\", \"BIGGER THAN SKY\", etc.</li><li>You may also narrow your search by entering information in multiple fields.</li><li>Click the <span class = \"helpBoldText\">Continue to Report Fields</span> button to view a list of available report fields for sample, organization, and analysis information.</li></ul><span class = \"helpHeader\"> Disclaimer: </span> <ul> <li>Results from this report represent analytical values as of the date they are generated.  Future revisions may affect these results and official final results should be reviewed from the <span class = \"helpBoldText\">Environmental Final Report</span> function to assure their accuracy.</li></ul></span>")
  ...
  /**
   * Translated "<span class = \"helpText\"><span class = \"helpHeader\"> Locating Your Results </span> <br/> <p/> You only need to enter information in one field to conduct a search for your results. Examples include: <span class=\"helpBoldText\">Collected Date</span>, <span class=\"helpBoldText\">Accession Number</span>, <span class=\"helpBoldText\">Collector Name</span>, or <span class=\"helpBoldText\">Patient''s Last Name</span> <p/> It is recommended that you use the calendar to the right of each date field when entering a date to eliminate any formatting errors. You must click out of the calendar to enter the selected date. <p/> You may also narrow your search by entering information in multiple fields. For example, to find all of the samples that you collected and sent to the laboratory in June of 2014, enter your name (as it appeared on the collection form) in the <span class=\"helpBoldText\">Collector Name</span> field and select (using the calendars provided) 2014-06-01 in the <span class=\"helpBoldText\">Collected Date</span> field and 2014-06-30 in the <span class=\"helpBoldText\">To</span> field.<p/> The system supports wild card searches in the following fields: <span class=\"helpBoldText\">Client Reference</span>, <span class=\"helpBoldText\">Collector Name</span>, <span class=\"helpBoldText\">PWS ID</span>, <span class=\"helpBoldText\">Patient''s First Name</span>, and <span class=\"helpBoldText\">Patient''s Last Name</span>. By using this search method you would add an * at the beginning and/or end of your search term. <p/> For example, to see a list of patient results for a patient whose last name starts with the letters <i>schm</i>, enter <i>schm*</i> in the <span class=\"helpBoldText\">Patient''s Last Name</span> field. Matches would include: <i>schmidt</i>, <i>schmitt</i>, <i>schmitz</i>, etc. <p/> In another example, to see a list of results for samples with a collector name of <i>buck</i>, enter <i>*buck*</i> in the <span class=\"helpBoldText\">Collector Name</span> field. Matches would include: <i>joseph buck</i>, <i>joe buck</i>, <i>j buck</i>, <i>buck joseph</i>, <i>buck joe</i>, <i>buck j</i>, etc.<p/> Click the <span class=\"helpBoldText\">Find Samples</span> button to display a list of samples that match your search criteria. The <span class=\"helpBoldText\">Reset</span> button clears all of the search fields.</span>".
   * 
   * @return translated "<span class = \"helpText\"><span class = \"helpHeader\"> Locating Your Results </span> <br/> <p/> You only need to enter information in one field to conduct a search for your results. Examples include: <span class=\"helpBoldText\">Collected Date</span>, <span class=\"helpBoldText\">Accession Number</span>, <span class=\"helpBoldText\">Collector Name</span>, or <span class=\"helpBoldText\">Patient''s Last Name</span> <p/> It is recommended that you use the calendar to the right of each date field when entering a date to eliminate any formatting errors. You must click out of the calendar to enter the selected date. <p/> You may also narrow your search by entering information in multiple fields. For example, to find all of the samples that you collected and sent to the laboratory in June of 2014, enter your name (as it appeared on the collection form) in the <span class=\"helpBoldText\">Collector Name</span> field and select (using the calendars provided) 2014-06-01 in the <span class=\"helpBoldText\">Collected Date</span> field and 2014-06-30 in the <span class=\"helpBoldText\">To</span> field.<p/> The system supports wild card searches in the following fields: <span class=\"helpBoldText\">Client Reference</span>, <span class=\"helpBoldText\">Collector Name</span>, <span class=\"helpBoldText\">PWS ID</span>, <span class=\"helpBoldText\">Patient''s First Name</span>, and <span class=\"helpBoldText\">Patient''s Last Name</span>. By using this search method you would add an * at the beginning and/or end of your search term. <p/> For example, to see a list of patient results for a patient whose last name starts with the letters <i>schm</i>, enter <i>schm*</i> in the <span class=\"helpBoldText\">Patient''s Last Name</span> field. Matches would include: <i>schmidt</i>, <i>schmitt</i>, <i>schmitz</i>, etc. <p/> In another example, to see a list of results for samples with a collector name of <i>buck</i>, enter <i>*buck*</i> in the <span class=\"helpBoldText\">Collector Name</span> field. Matches would include: <i>joseph buck</i>, <i>joe buck</i>, <i>j buck</i>, <i>buck joseph</i>, <i>buck joe</i>, <i>buck j</i>, etc.<p/> Click the <span class=\"helpBoldText\">Find Samples</span> button to display a list of samples that match your search criteria. The <span class=\"helpBoldText\">Reset</span> button clears all of the search fields.</span>"
   */
  @DefaultMessage("<span class = \"helpText\"><span class = \"helpHeader\"> Locating Your Results </span> <br/> <p/> You only need to enter information in one field to conduct a search for your results. Examples include: <span class=\"helpBoldText\">Collected Date</span>, <span class=\"helpBoldText\">Accession Number</span>, <span class=\"helpBoldText\">Collector Name</span>, or <span class=\"helpBoldText\">Patient''s Last Name</span> <p/> It is recommended that you use the calendar to the right of each date field when entering a date to eliminate any formatting errors. You must click out of the calendar to enter the selected date. <p/> You may also narrow your search by entering information in multiple fields. For example, to find all of the samples that you collected and sent to the laboratory in June of 2014, enter your name (as it appeared on the collection form) in the <span class=\"helpBoldText\">Collector Name</span> field and select (using the calendars provided) 2014-06-01 in the <span class=\"helpBoldText\">Collected Date</span> field and 2014-06-30 in the <span class=\"helpBoldText\">To</span> field.<p/> The system supports wild card searches in the following fields: <span class=\"helpBoldText\">Client Reference</span>, <span class=\"helpBoldText\">Collector Name</span>, <span class=\"helpBoldText\">PWS ID</span>, <span class=\"helpBoldText\">Patient''s First Name</span>, and <span class=\"helpBoldText\">Patient''s Last Name</span>. By using this search method you would add an * at the beginning and/or end of your search term. <p/> For example, to see a list of patient results for a patient whose last name starts with the letters <i>schm</i>, enter <i>schm*</i> in the <span class=\"helpBoldText\">Patient''s Last Name</span> field. Matches would include: <i>schmidt</i>, <i>schmitt</i>, <i>schmitz</i>, etc. <p/> In another example, to see a list of results for samples with a collector name of <i>buck</i>, enter <i>*buck*</i> in the <span class=\"helpBoldText\">Collector Name</span> field. Matches would include: <i>joseph buck</i>, <i>joe buck</i>, <i>j buck</i>, <i>buck joseph</i>, <i>buck joe</i>, <i>buck j</i>, etc.<p/> Click the <span class=\"helpBoldText\">Find Samples</span> button to display a list of samples that match your search criteria. The <span class=\"helpBoldText\">Reset</span> button clears all of the search fields.</span>")
  ...
  /**
   * Translated "<span class = \"helpText\"> <span class = \"helpHeader\">Locating Samples Sent to the Laboratory </span><br/><br/>To locate samples submitted to the laboratory, you must know at least one or more of the following criteria: <ul><li>Collection Date</li><li>Accession Number</li><li>Client Reference</li><li>Project Code</li></ul><span class = \"helpHeader\">To Find the Status of Samples </span><br/><ul><li>If searching by sample collection date, specify the beginning date in the <span class = \"helpBoldText\">Collected Date</span> and the ending date in the <span class = \"helpBoldText\">To</span> field. It is recommended that you use the provided calendars to the right of these fields when inputting dates to eliminate any formatting errors. Click on <span class = \"helpBoldText\">Today</span> at the bottom of the calendar to enter today''s date. </li><li>To locate samples by the reference information that you supplied on the collection form, enter the reference information in the <span class = \"helpBoldText\">Client Reference</span> field. You may use part of a reference by adding a \"*\" at the end of your search term (known as a wildcard search). For example, to see a list of samples that share the first three letters \"BIG\", enter \"BIG*\". Matches would include \"BIG WATER\", \"BIG RIVER\", \"BIGGER THAN SKY\", etc. </li><li>You may also narrow your search by entering information in multiple fields.</li></ul></span>".
   * 
   * @return translated "<span class = \"helpText\"> <span class = \"helpHeader\">Locating Samples Sent to the Laboratory </span><br/><br/>To locate samples submitted to the laboratory, you must know at least one or more of the following criteria: <ul><li>Collection Date</li><li>Accession Number</li><li>Client Reference</li><li>Project Code</li></ul><span class = \"helpHeader\">To Find the Status of Samples </span><br/><ul><li>If searching by sample collection date, specify the beginning date in the <span class = \"helpBoldText\">Collected Date</span> and the ending date in the <span class = \"helpBoldText\">To</span> field. It is recommended that you use the provided calendars to the right of these fields when inputting dates to eliminate any formatting errors. Click on <span class = \"helpBoldText\">Today</span> at the bottom of the calendar to enter today''s date. </li><li>To locate samples by the reference information that you supplied on the collection form, enter the reference information in the <span class = \"helpBoldText\">Client Reference</span> field. You may use part of a reference by adding a \"*\" at the end of your search term (known as a wildcard search). For example, to see a list of samples that share the first three letters \"BIG\", enter \"BIG*\". Matches would include \"BIG WATER\", \"BIG RIVER\", \"BIGGER THAN SKY\", etc. </li><li>You may also narrow your search by entering information in multiple fields.</li></ul></span>"
   */
  @DefaultMessage("<span class = \"helpText\"> <span class = \"helpHeader\">Locating Samples Sent to the Laboratory </span><br/><br/>To locate samples submitted to the laboratory, you must know at least one or more of the following criteria: <ul><li>Collection Date</li><li>Accession Number</li><li>Client Reference</li><li>Project Code</li></ul><span class = \"helpHeader\">To Find the Status of Samples </span><br/><ul><li>If searching by sample collection date, specify the beginning date in the <span class = \"helpBoldText\">Collected Date</span> and the ending date in the <span class = \"helpBoldText\">To</span> field. It is recommended that you use the provided calendars to the right of these fields when inputting dates to eliminate any formatting errors. Click on <span class = \"helpBoldText\">Today</span> at the bottom of the calendar to enter today''s date. </li><li>To locate samples by the reference information that you supplied on the collection form, enter the reference information in the <span class = \"helpBoldText\">Client Reference</span> field. You may use part of a reference by adding a \"*\" at the end of your search term (known as a wildcard search). For example, to see a list of samples that share the first three letters \"BIG\", enter \"BIG*\". Matches would include \"BIG WATER\", \"BIG RIVER\", \"BIGGER THAN SKY\", etc. </li><li>You may also narrow your search by entering information in multiple fields.</li></ul></span>")
