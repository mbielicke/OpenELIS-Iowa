...
public class CaseResultDO extends DataObject {
	...
	private Integer id,caseAnalysisId,testAnalyteId,testResultId,row,col,analyteId,typeId;
	private String isReportable,value;
	
	public CaseResultDO() {
		
	}
	
	public CaseResultDO(Integer id,Integer caseAnalysisId,Integer testAnalyteId,
			            Integer testResultId, Integer row, Integer col, String isReportable,
	...
	public void setIsReportable(String isReportable) {
		this.isReportable = trim(isReportable);
		_changed = true;
	}
