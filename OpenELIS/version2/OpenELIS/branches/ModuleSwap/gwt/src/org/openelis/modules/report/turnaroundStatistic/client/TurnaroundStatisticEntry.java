...
public class TurnaroundStatisticEntry implements EntryPoint {
    
    @Override
    public void onModuleLoad() {
        OpenELISEntry.mainBus.addHandler(OpenELIS.TURNAROUND_STATISTIC_REPORT, new ShowScreenHandler() {
