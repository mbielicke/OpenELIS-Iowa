...
<xsl:stylesheet
  ...
  <xsl:template match="doc">
    <screen id="NeonatalScreeningSampleLogin" name="{resource:getString($constants,'neonatalScreeningSampleLogin')}">
              ...
              <VerticalPanel style="subform">
                ...
                <TablePanel style="Form">
                  ...
                  <row>
                    ...
                    <widget colspan="3">
                      <textbox field = "String" key="{meta:getNeoNextOfKinAddrHomePhone()}" width="120"/>
                    </widget>   
                  </row>
                  <row>
                    <text style="Prompt"><xsl:value-of select="resource:getString($constants,'aptSuite')" />:</text>
                  ...
                  <row>
                     <text style="Prompt"><xsl:value-of select="resource:getString($constants,'address')" />:</text>
                     <widget colspan="5">
                         <textbox field = "String" key="{meta:getNeoNextOfKinAddrStreetAddress()}" width="222"/>
                     </widget>
                 </row>
                 <row>
              ...
              <VerticalPanel style="subform">
                ...
                <TablePanel style="Form">
                    ...
                    <row>   
                       ...
                       <widget colspan="4">
                         <textbox field = "Integer" key="{meta:getNeoBirthOrder()}" width="35"/>
                       </widget>
                    </row> 
                    <row>                       
            ...
            <VerticalPanel style="subform">
              ...
              <TablePanel style="Form">
                <row>
                    ...
                    <autoComplete key="{meta:getNeoProviderLastName()}" width="130" case="UPPER" popWidth="auto" tab="{meta:getOrgName()},{meta:getEnvDescription()}" field="Integer">
                        <col width="150" header="{resource:getString($constants,'lastName')}" />
                        <col width="150" header="{resource:getString($constants,'firstName')}" />
                        <col width="150" header="{resource:getString($constants,'middleName')}" />
                      </autoComplete>
                    <textbox key="{meta:getNeoProviderFirstName()}" style = "ScreenTextboxDisplayOnly" width="130" max="20" field="String" />
                  </row>
                <row>
                  <text style="Prompt">
                  ...
                  <widget colspan="3">
                    <HorizontalPanel>
                      ...
                      <appButton key="projectButton" style="LookupButton">
                        <AbsolutePanel style="LookupButtonImage" />
                      </appButton>
                    </HorizontalPanel>
                  </widget>
                ...
                <row>
                  ...
                  <widget colspan="3">
                    <HorizontalPanel>
                      ...
                      <appButton key="reportToButton" style="LookupButton">
                        <AbsolutePanel style="LookupButtonImage" />
                      </appButton>
                    </HorizontalPanel>
                  </widget>
                ...
                <row>
                  ...
                  <widget colspan="3">
                    <HorizontalPanel>
                      ...
                      <appButton key="birthHospitalButton" style="LookupButton">
                        <AbsolutePanel style="LookupButtonImage" />
                      </appButton>
                    </HorizontalPanel>
                  </widget>
                ...
                <row>
                  ...
                  <widget colspan="3">
                    <textbox field = "Integer" key="{meta:getNeoFormNumber()}" width="150"/>
                  </widget>
                </row>
              </TablePanel>
            </VerticalPanel>
