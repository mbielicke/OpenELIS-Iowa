...
public class TestAnalyteLookupScreen1 extends Screen implements HasActionHandlers<TestAnalyteLookupScreen1.Action>{
    ...
    public TestAnalyteLookupScreen1() throws Exception {
        super((ScreenDefInt)GWT.create(TestAnalyteLookupDef1.class));
    ...
    public HandlerRegistration addActionHandler(ActionHandler<TestAnalyteLookupScreen1.Action> handler) {
