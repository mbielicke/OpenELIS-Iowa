...
<xsl:stylesheet
  ...
  <screen name="PrivateWell">
                ...
                <row>
                  ...
                  <widget colspan="3">
                    <autoComplete key="{meta:getWellOrganizationName()}" width="180" case="UPPER" tab="{meta:getWellOrganizationId()},{meta:getBillTo()}" >
                ...
                <row>
                  ...
                  <widget colspan="5">
                  <HorizontalPanel>
                    <autoComplete key="{meta:getProjectName()}" width="182" case="UPPER" tab="{meta:getBillTo()},{meta:getWellWellNumber()}" >
                ...
                <row>
                  ...
                  <widget colspan="5">
                  <HorizontalPanel>
                    <autoComplete key="{meta:getBillTo()}" width="182" case="UPPER" tab="{meta:getWellOrganizationName()},{meta:getProjectName()}">
