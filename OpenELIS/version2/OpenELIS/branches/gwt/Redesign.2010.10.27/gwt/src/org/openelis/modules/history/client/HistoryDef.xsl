...
<xsl:stylesheet
  ...
  <xsl:template match="doc">
    ...
    <screen xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" name="{resource:getString($constants,'history')}">
      <VerticalPanel>
...
<!--left table goes here -->
          <VerticalPanel style="WhiteContentPanel">
            <VerticalPanel spacing="0">
              <widget>
                <tree key="historyTree" rows="10" vscroll="ALWAYS">
                  <columns>
