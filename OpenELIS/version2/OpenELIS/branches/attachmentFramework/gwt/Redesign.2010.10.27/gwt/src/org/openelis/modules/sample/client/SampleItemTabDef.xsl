    ...
    <VerticalPanel padding="0" spacing="0">
      <TablePanel style="Form">
        <row>
          ...
          <dropdown key="{meta:getItemTypeOfSampleId()}" tab="{meta:getItemSourceOfSampleId()},{meta:getItemUnitOfMeasureId()}" width="150" field="Integer" />
        </row>
        <row>
          <text style="Prompt">
            <xsl:value-of select="resource:getString($constants,'source')" />:
          </text>
          <dropdown key="{meta:getItemSourceOfSampleId()}" width="150" field="Integer" tab="{meta:getItemSourceOther()},{meta:getItemTypeOfSampleId()}"/>
          <text style="Prompt">
        ...
        <row>
          ...
          <dropdown key="{meta:getItemContainerId()}" width="225" field="Integer" tab="{meta:getItemContainerReference()},{meta:getItemSourceOther()}"/>
          <text style="Prompt">
        ...
        <row>
          ...
          <dropdown key="{meta:getItemUnitOfMeasureId()}" width="150" field="Integer" tab="{meta:getItemTypeOfSampleId()},{meta:getItemQuantity()}"/>
        </row>
      </TablePanel>
