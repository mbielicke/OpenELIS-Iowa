...
<xsl:stylesheet
  ...
  <xsl:template match="doc">
    ...
    <screen name="{resource:getString($constants,'systemVariable')}">
          ...
          <AbsolutePanel spacing="0" style="ButtonPanelContainer">
            <HorizontalPanel>
              ...
              <menu key="optionsMenu" selfShow="true" showBelow="true">
                  ...
                  <menuItem key="systemVariableHistory" enabled="false" icon="historyIcon" display="{resource:getString($constants,'systemVariableHistory')}" />
              </menu>
            </HorizontalPanel>
          </AbsolutePanel>
<!--end button panel-->
