...
public class StorageScreen extends Screen {
    ...
    private Button                 queryButton, previousButton, nextButton,
    ...
    private void initialize() {
        ...
        addScreenHandler(commitButton, new ScreenEventHandler<Object>() {
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                commitButton.setEnabled(EnumSet.of(State.QUERY, State.UPDATE)
                                           .contains(event.getState()));
            }
        });
        ...
        addScreenHandler(abortButton, new ScreenEventHandler<Object>() {
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                abortButton.setEnabled(EnumSet.of(State.QUERY,State.UPDATE)
                                          .contains(event.getState()));
            }
        });
        ...
        addScreenHandler(location, new ScreenEventHandler<String>() {
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                location.setEnabled(EnumSet.of(State.QUERY).contains(event.getState()));
        ...
        addScreenHandler(storageUnitDescription, new ScreenEventHandler<String>() {
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                storageUnitDescription.setEnabled(EnumSet.of(State.QUERY).contains(event.getState()));
        ...
        addScreenHandler(isAvailable, new ScreenEventHandler<String>() {
            ...
            public void onStateChange(StateChangeEvent<State> event) {
                isAvailable.setEnabled(EnumSet.of(State.QUERY).contains(event.getState()));
                ...
                storageLocationService.callList("query", query, new AsyncCallback<ArrayList<IdNameVO>>() {
                    ...
                    public void onFailure(Throwable error) {
                        ...
                        if (error instanceof NotFoundException) {
                            ...
                            com.google.gwt.user.client.Window.alert("Error: Storage call query failed; " +
                                         error.getMessage());
        ...
        addScreenHandler(atoz, new ScreenEventHandler<Object>() {
            ...
            public void onClick(ClickEvent event) {
                ...
                field = new QueryData(StorageMeta.getStorageLocationName(),QueryData.Type.STRING,((Button)event.getSource()).getAction());
