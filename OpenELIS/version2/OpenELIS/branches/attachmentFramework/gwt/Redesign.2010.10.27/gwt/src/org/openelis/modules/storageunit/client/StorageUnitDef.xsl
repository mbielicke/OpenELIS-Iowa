...
<xsl:stylesheet
  ...
  <xsl:template match="doc">
    ...
    <screen xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" name="{resource:getString($constants,'storageUnit')}">
          ...
          <AbsolutePanel spacing="0" style="ButtonPanelContainer">
            <HorizontalPanel>
              ...
              <menu key="optionsMenu" selfShow="true" showBelow="true">
                  ...
                  <menuItem key="storageUnitHistory" enabled="false" icon="historyIcon" display="{resource:getString($constants,'storageUnitHistory')}" />
              </menu>
            </HorizontalPanel>
          </AbsolutePanel>
<!--end button panel-->
