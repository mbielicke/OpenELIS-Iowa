...
/**
 * A number with an associated number of significant figures. This class handles
 * parsing numbers, determining the number of significant figures, adjusting the
 * number of significant figures (including scientific rounding), and displaying
 * the number. More information about this class is available from <a
 * target="_top" href=
 * "http://ostermiller.org/utils/SignificantFigures.html">ostermiller.org</a>.
 * <p>
 * When parsing a number to determine the number of significant figures, these
 * rules are used:
 * <ul>
 * <li>Non-zero digits are always significant.</li>
 * <li>All zeros between other significant digits are significant.</li>
 * <li>All zeros left of the decimal point between a significant digit and the
 * decimal point are significant.</li>
 * <li>All trailing zeros to the right of the decimal point are significant.</li>
 * <li>If the number is contains no digits other than zero, every zero is
 * significant.</li>
 * </ul>
 * <p>
 ...
 * <li>If the greatest insignificant digit is five and followed by some non-zero
 * digit, round up.</li>
 * <li>If the greatest insignificant digit is five and followed only by zeros,
 * and the least significant digit is odd, round up.</li>
 * <li>If the greatest insignificant digit is five and followed only by zeros,
 * and the least significant digit is even, round down.</li>
 * </ul>
 * 
 * <p>
 * Example of using this class to multiply numbers and display the result with
 * the proper number of significant figures:<br>
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * Example of using this class to add numbers and display the result with the
 * proper number of significant figures:<br>
 * 
 * <pre>
 * String[] arguments = {"1.0", "2.0", ...}
 * SignificantFigures number;
...
public class SignificantFigures extends Number {
    ...
    /**
     * In the case the a number could not be parsed, the original is stored for
     * toString purposes.
     * 
     * @since ostermillerutils 1.00.00
     */
    ...
    /**
     * Create a SignificantFigures object from a java number such as a
     * BigDecimal, BigInteger, Byte, Double, Float, Integer, Long, or Short.
     * 
     * @param number
     *        a number.
     * 
    ...
    /**
     * Adjust the number of significant figures such that the least significant
     * digit is at the given place. This method may add significant zeros to the
     * end of this number, or remove significant digits from this number.
     * <p>
     ...
     * the least significant place, a zero will be created with significant
     * figures from the least to most significant places.
     * <p>
     * This method has no effect if this number is not a number or infinity.
     * 
     * @param leastPlace
     *        the desired place of the least significant digit or
     *        Integer.MIN_VALUE to ignore.
     * @param mostPlace
     *        the desired place of the most significant digit or
     *        Integer.MIN_VALUE to ignore.
     * @return this number
     * 
     * @since ostermillerutils 1.00.00
     ...
     * <p>
     * If this number is not a number or infinity Integer.MIN_VALUE will be
     * returned.
     * 
    ...
    /**
     * Formats this number. If the number is less than 10^-3 or greater than or
     * equal to 10^7, or the number might have an ambiguous number of
     * significant figures, scientific notation will be used.
     * <p>
    ...
    /**
     * Parsing state: State in which a possible sign and possible leading zeros
     * have been read.
     * 
     * @since ostermillerutils 1.00.00
     */
    ...
    /**
     * Parsing state: State in which a possible sign and at least one non-zero
     * digit has been read followed by some number of zeros. The decimal place
     * has no been encountered yet.
     * 
     * @since ostermillerutils 1.00.00
     */
    ...
    /**
     * Parsing state: State in which a possible sign and at least one non-zero
     * digit has been read. The decimal place has no been encountered yet.
     * 
     * @since ostermillerutils 1.00.00
     */
    private final static int DIGITS        = 3;
    /**
     * Parsing state: State in which only a possible sign, leading zeros, and a
    ...
    /**
     * Parsing state: State in which a possible sign, at least one nonzero digit
     * and a decimal point have been encountered.
     * 
     * @since ostermillerutils 1.00.00
     */
    private final static int DIGITSDOT     = 5;
    /**
     * Parsing state: State in which the exponent symbol 'E' has been
     * encountered.
     * 
     * @since ostermillerutils 1.00.00
     */
    ...
    /**
     * Parsing state: State in which the exponent symbol 'E' has been
     * encountered followed by a possible sign or some number of digits.
     * 
     * @since ostermillerutils 1.00.00
     */
    ...
    /**
     * Parse a number from the given string. A valid number has an optional
     * sign, some digits with an optional decimal point, and an optional
     * scientific notation part consisting of an 'E' followed by an optional
     * sign, followed by some digits.
     * 
     * @param number
    ...
    /**
     * Adjust the number of digits in the number. Pad the tail with zeros if too
     * short, round the number according to scientific rounding if too long,
     * leave alone if just right.
     * <p>
     * This method has no effect if this number is not a number or infinity.
     * 
     ...
     *         type byte.
     * @throws NumberFormatException
     *         if this number cannot be converted to a byte.
     * 
     * @since ostermillerutils 1.00.00
     */
    @Override
     ...
     *         type double.
     * @throws NumberFormatException
     *         if this number cannot be converted to a double.
     * 
     * @since ostermillerutils 1.00.00
     */
    @Override
     ...
     *         type float.
     * @throws NumberFormatException
     *         if this number cannot be converted to a float.
     * 
     * @since ostermillerutils 1.00.00
     */
    @Override
     ...
     *         type int.
     * @throws NumberFormatException
     *         if this number cannot be converted to a int.
     * 
     * @since ostermillerutils 1.00.00
     */
    @Override
     ...
     *         type long.
     * @throws NumberFormatException
     *         if this number cannot be converted to a long.
     * 
     * @since ostermillerutils 1.00.00
     */
    @Override
     ...
     *         type short.
     * @throws NumberFormatException
     *         if this number cannot be converted to a short.
     * 
     * @since ostermillerutils 1.00.00
     */
    @Override
    ...
    /**
     * Convenience method to display a number with the correct significant
     * digits.
     * 
     * @param number
