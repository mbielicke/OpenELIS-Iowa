...
public class ShippingStatusCacheHandler implements MessageHandler<ShippingStatusCacheMessage> {
    ...
    public static TableDataModel<TableDataRow<Integer>> getShippingStatuses() {
        TableDataModel<TableDataRow<Integer>> model = (TableDataModel<TableDataRow<Integer>>)CachingManager.getElement("InitialData", "shippingStatusDropdown");
        if(model == null) {
