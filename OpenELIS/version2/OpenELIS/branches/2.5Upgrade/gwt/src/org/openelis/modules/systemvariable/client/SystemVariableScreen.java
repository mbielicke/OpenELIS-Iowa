...
public class SystemVariableScreen extends Screen {
    ...
    public SystemVariableScreen(WindowInt window) throws Exception {
        ...
        if (userPermission == null)
            throw new PermissionException(Messages.get().screenPermException("System Variable Screen"));
    ...
    protected void history() {
        ...
        HistoryScreen.showHistory(Messages.get().systemVariableHistory(), Constants.table().SYSTEM_VARIABLE, hist);
    }
