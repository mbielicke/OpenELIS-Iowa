...
public class FinalReportSDWISScreen extends Screen {
    ...
    public FinalReportSDWISScreen(WindowInt win) throws Exception {
        ...
        if (userPermission == null)
            throw new PermissionException(Messages.get().screenPermException("Final Report SDWIS Screen"));
    ...
    private void initializeDropdowns() {
        ...
        try {
            projects = FinalReportService.get().getSDWISProjectList();
    ...
    protected void getSamples() {
        ...
        FinalReportService.get().getSampleSDWISList(query, new AsyncCallback<ArrayList<FinalReportWebVO>>() {
