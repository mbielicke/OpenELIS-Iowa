                ...
                for (Integer aMonth:specsInOrder[MONTHS]) {
                        ...
                        for (Integer aDay:specsForCurrentMonth) {
                                ...
                                if (specsForCurrentDay.length > 0) {
                                        ...
                                        int hindex = 0;
                                        if (specsForCurrentDay[hindex].equals(fields[HOURS])) {
                                                specsForCurrentHour =
                                                        specsForReferenceParent[MINUTES][pass];
                                                if(specsForCurrentHour.length == 0 && specsForCurrentDay.length > 1) {
                                                	hindex = 1;
                                        ...
                                        if (specsForCurrentHour.length > 0) {
                                                ...
                                                match.set(Calendar.HOUR_OF_DAY, specsForCurrentDay[hindex]);
