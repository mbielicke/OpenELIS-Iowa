...
public class NotificationPreferenceService implements NotificationPreferenceServiceInt, NotificationPreferenceServiceIntAsync {
    
    private static NotificationPreferenceService instance;
    
    private NotificationPreferenceServiceIntAsync service;
    
    public static NotificationPreferenceService get() {
        if (instance == null)
            instance = new NotificationPreferenceService();
        return instance;
    }
    
    private NotificationPreferenceService() {
        service = (NotificationPreferenceServiceIntAsync)GWT.create(NotificationPreferenceServiceInt.class);
    }
