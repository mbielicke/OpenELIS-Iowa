...
@NamedQuery(name = "InventoryLocation.AutoCompleteByName", query = "select distinct new org.openelis.domain.StorageLocationAutoDO(childLoc.id, childLoc.name, i.id, childLoc.location, " +
