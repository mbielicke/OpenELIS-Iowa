...
public class Organization implements Auditable, Cloneable {
    ...
    public void setParentOrganizationId(Integer parentOrganization) {
        if ((parentOrganization == null && this.parentOrganizationId != null)
                || (parentOrganization != null && !parentOrganization
                        .equals(this.parentOrganizationId)))
    ...
    public String getChangeXML() {
        try {
            ...
            //getChangeXML(doc,id,original.id,"id");
            ...
            if ((parentOrganizationId == null && original.parentOrganizationId != null)
                    || (parentOrganizationId != null && !parentOrganizationId
                            .equals(original.parentOrganizationId))) {
                Element elem = doc.createElement("parent_organization");
                elem.appendChild(doc
                        .createTextNode(original.parentOrganizationId
                                .toString().trim()));
                root.appendChild(elem);
            }
            ...
            if ((isActive == null && original.isActive != null)
                ...
                elem.appendChild(doc.createTextNode(original.isActive
                        .toString().trim()));
                root.appendChild(elem);
            }
            ...
            if ((addressId == null && original.addressId != null)
                    || (addressId != null && !addressId
                            .equals(original.addressId))) {
                Element elem = doc.createElement("address");
                elem.appendChild(doc.createTextNode(original.addressId
                        .toString().trim()));
                root.appendChild(elem);
            }
    ...
    /*private void getChangeXML(doc,id,original.id,"id"){
    	if ((addressId == null && original.addressId != null)
                || (addressId != null && !addressId
                        .equals(original.addressId))) {
            Element elem = doc.createElement("address");
