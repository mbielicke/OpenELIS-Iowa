...
public class AnalysisManagerProxy {
    ...
    private void add(AnalysisManager man, AnalysisViewDO analysisDO, int i) throws Exception {
        ...
        arfDO = new AnalysisReportFlagsDO(analysisDO.getId(), "N", "N", null, null, null);
    ...
    public void validate(SampleManager man, AnalysisManager anaMan, String sampleItemSequence, Integer sampleTypeId,
