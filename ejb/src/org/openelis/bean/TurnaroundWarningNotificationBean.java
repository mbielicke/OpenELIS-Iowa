        ...
        try {
            ...
            if (resultList.size() > 0) {
                ...
                for (Integer aId : analysisIds) {
                    ...
                    /*
                     * If an analysis was found in the turnaround query but not
                     * in the SampleManager query, it is an orphan analysis left
                     * over from a bug that used to be in the Send-out IOrder
                     * import code.
                     */
                    if (aVDO == null)
                        continue;
                    ...
                    if ( !prevSectId.equals(aVDO.getSectionId())) {
                        if (prevSectId != -1) {
                            ...
                            sendEmail(from,
                                      to,
                                      "Turnaround Warning Notification: " + prevSectName,
                                      contents.toString());
                            to = "";
                        ...
                        try {
                            ...
                            log.fine("No Turnaround Warning Email Address(es) for Section (" +
                                     aVDO.getSectionName() + ").");
                            continue;
                        }
