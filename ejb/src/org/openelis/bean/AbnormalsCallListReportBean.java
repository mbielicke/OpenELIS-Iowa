...
public class AbnormalsCallListReportBean {
    ...
    public ArrayList<Prompt> getPrompts() throws Exception {
        ...
        try {
            ...
            p.add(new Prompt("FROM", Prompt.Type.DATETIME).setPrompt("Starting Released Date:")
                                                          .setWidth(150)
            ...
            p.add(new Prompt("TO", Prompt.Type.DATETIME).setPrompt("Ending Released Date:")
                                                        .setWidth(150)
                                                        .setDatetimeStartCode(Prompt.Datetime.YEAR)
                                                        .setDatetimeEndCode(Prompt.Datetime.MINUTE)
                                                        .setDefaultValue(ReportUtil.toString(new Date(),
    ...
    public ReportStatus runReport(ArrayList<QueryData> paramList) throws Exception {
        ...
        session.setAttribute("AbnormalsCallListReport", status);
        ...
        try {
            ...
            url = ReportUtil.getResourceURL("org/openelis/report/abnormalsCallList/main.jasper");
    ...
    private Path export(JasperPrint print, String systemVariableDirectory) throws Exception {
        ...
        try {
            ...
            path = ReportUtil.createTempFile("abnormalsCallList", ".pdf", systemVariableDirectory);
            ...
            try {
                ...
                log.severe("Could not close output stream for abnormals call list report");
            }
        }
