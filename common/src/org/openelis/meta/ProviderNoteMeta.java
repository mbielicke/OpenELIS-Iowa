...
public class ProviderNoteMeta implements Meta {
    private String tableName = "note";
    private String entityName = "provider.provNote";
    ...
    private static final ProviderNoteMeta providerNoteMeta = new ProviderNoteMeta();
    ...
    private ProviderNoteMeta() {

    }

    public static ProviderNoteMeta getInstance(){
        return providerNoteMeta;
    }
