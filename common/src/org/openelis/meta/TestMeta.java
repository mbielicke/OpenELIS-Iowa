...
public class TestMeta implements Meta {
	...
	public static final String
              ...
              REPORTING_DESCRIPTION					="test.reportingDescription",
              METHOD_ID					="test.methodId",
              IS_ACTIVE					="test.isActive",
              ACTIVE_BEGIN					="test.activeBegin",
              ACTIVE_END					="test.activeEnd",
              IS_REPORTABLE					="test.isReportable",
              TIME_TRANSIT					="test.timeTransit",
              TIME_HOLDING					="test.timeHolding",
              TIME_TA_AVERAGE					="test.timeTaAverage",
              TIME_TA_WARNING					="test.timeTaWarning",
              TIME_TA_MAX					="test.timeTaMax",
              LABEL_ID					="test.labelId",
              LABEL_QTY					="test.labelQty",
              TEST_TRAILER_ID					="test.testTrailerId",
              SECTION_ID					="test.sectionId",
              SCRIPTLET_ID					="test.scriptletId",
              TEST_FORMAT_ID					="test.testFormatId",
              REVISION_METHOD_ID					="test.revisionMethodId";
