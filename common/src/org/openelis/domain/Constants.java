...
public class Constants implements Serializable {
    ...
    public static class Dictionary implements Serializable {
        ...
        public Integer            ANALYSIS_CANCELLED, ANALYSIS_COMPLETED, ANALYSIS_ERROR_COMPLETED,
                        ...
                        PATIENT_RELATION_MOTHER, PATIENT_RELATION_FATHER, PATIENT_RELATION_GUARDIAN,
                        PATIENT_RELATION_SELF, POS_DUPLICATE, POS_FIXED,
                        ...
                        ORG_HOLD_SAMPLE, ORG_PROD_EPARTNER_URL, ORG_TEST_EPARTNER_URL,
                        ORG_EPARTNER_AGGR, REFLEX_AUTO, REFLEX_PROMPT, REFLEX_AUTO_NDUP,
                        REFLEX_PROMPT_NDUP, RESULT_FLAG_ABNORMAL, RESULT_FLAG_ABNORMAL_CDC,
                        RESULT_FLAG_ABNORMAL_DNR, RESULT_FLAG_ABNORMAL_DPH, RESULT_FLAG_CDC,
                        ...
                        SCRIPTLET_NEONATAL_DOMAIN, SCRIPTLET_PWS_VALIDATE, ANIMAL, ENVIRONMENTAL,
                        CLINICAL, NEWBORN, PT, PRIVATE_WELL, QUICK_ENTRY, SDWIS,
    ...
    public static class UID implements Serializable {
        ...
        public String getScriptlet(Integer id) {
            return Constants.table().SCRIPTLET + ":" + id;
        }
