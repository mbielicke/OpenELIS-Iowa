...
public class SampleNeonatalViewDO extends SampleNeonatalDO {
    ...
    public SampleNeonatalViewDO(Integer id, Integer sampleId, Integer patientId,
                                ...
                                String patientNationalId, String patientMultipleUnit,
                                String patientStreetAddress, String patientCity,
                                String patientState, String patientZipCode, String patientWorkPhone,
                                String patientHomePhone, String patientCellPhone,
                                ...
                                Integer nextOfKinEthnicityId, String nextOfKinNationalId,
        ...
        super(id, sampleId, patientId, birthOrder, gestationalAge, nextOfKinId,
              ...
              formNumber, patientLastName, patientFirstName, patientMiddleName,
              patientAddressId, patientBirthDate, patientBirthTime, patientGenderId,
              patientRaceId, patientEthnicityId, patientNationalId, patientMultipleUnit,
              patientStreetAddress, patientCity, patientState, patientZipCode, patientWorkPhone,
              patientHomePhone, patientCellPhone, patientFaxPhone, patientEmail,
              patientCountry, nextOfKinLastName, nextOfKinFirstName, nextOfKinMiddleName,
              nextOfKinAddressId, nextOfKinBirthDate, nextOfKinBirthTime, nextOfKinGenderId,
              nextOfKinRaceId, nextOfKinEthnicityId, nextOfKinNationalId, nextOfKinMultipleUnit,
