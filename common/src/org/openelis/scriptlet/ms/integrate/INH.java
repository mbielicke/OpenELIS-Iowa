...
/**
 * The class that stores data for INH; it also computes weight adjustment factor
 * for MoM and median based on gestational age
 */
public class INH extends Test {
    public INH() {
        super(0.89, 1.0, new Double[] {0.0, 0.0}, new Double[] {.3, 5.0}, new Double[] {0.0, 0.0},
              105, 146, Messages.get().scriptlet_inhibin());
    }
