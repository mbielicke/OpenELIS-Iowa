...
public abstract class Test {
     ...
     */
    protected Double getMom() {
        return mom;
    }
    
    /**
     * Sets the computed MoM
     */
     ...
     */
    protected void computeMoms(int gestAge, Datetime entered, Double weight,
                            boolean isRaceBlack, boolean isDiabetic) throws Exception {
        double mom;

        if (getResult() != null) {
            try {
                mom = getMoM(gestAge, entered, weight, isRaceBlack, isDiabetic);
     ...
     */
    protected abstract double getMedian(int ga) throws Exception;    
