...
public class AnalysisResultManager implements RPC {
    ...
    public void addRowAt(int index, Integer rowGroup, Integer firstColTestAnalyteId, 
        ...
        currlist = createNewDataListAt(index, rowGroup, firstColTestAnalyteId, firstColAnalyteId, firstColAnalyteName);
    ...
    public ArrayList<TestAnalyteViewDO> getNonColumnTestAnalytes(Integer rowGroup){
        ...
        if(!loaded){
            ...
            for(int i=0; i<list.size(); i++){
                ...
                while(j<aliasList.size() && aliasList.get(j).getParentAnalyteId().equals(taDO.getAnalyteId())){
    ...
    private ArrayList<ResultViewDO> createNewDataListAt(int row, Integer rowGroup, Integer testAnalyteId, Integer analyteId, 
                                                        String analyteName) {
        ResultViewDO currDO;
    ...
    private ResultViewDO createResultViewDO(String isColumn, Integer rowGroup, Integer testAnalyteId, 
