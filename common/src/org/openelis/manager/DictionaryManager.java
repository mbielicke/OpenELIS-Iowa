...
public class DictionaryManager implements RPC {
    ...
    protected ArrayList<DictionaryViewDO> entries,deletedEntries;
    ...
    /**
     * Creates a new instance of this object. A default category object is also created.    
     */
    public static DictionaryManager getInstance() {
        ...
        dm.entries = new ArrayList<DictionaryViewDO>();
        return dm;
    }
    ...
    public void removeEntryAt(int i) {
        ...
        if(entry.getId() != null)
            if(deletedEntries == null)
                deletedEntries = new ArrayList<DictionaryViewDO>();
